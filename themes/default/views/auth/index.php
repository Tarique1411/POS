    ...
    $(document).ready(function () {
        ...
        var oTable = $('#UsrTable').dataTable({
            ...
            "aoColumns": [/*{
                "bSortable": false,
                "mRender": checkbox
            },*/{"bVisible":false}, null, null, null, null,{"mRender": user_status}, {"bSortable": false}]
...
//            {column_number: 5, filter_default_label: "[<?=lang('award_points');?>]", filter_type: "text", data: []},
            ...
            {column_number: 6, filter_default_label: "[<?=lang('actions');?>]", filter_type: "text", data: []},
        ], "footer");
    });
</script>
                ...
                <?php if($Owner) { ?>    
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="#" class="bpo" title="<b><?= $this->lang->line("delete_users") ?></b>"
                               ...
                               data-html="true" data-placement="left"><i class="fa fa-trash-o"></i> <?= lang('delete_users') ?></a></li> --
                    </ul>
                <?php } /*else { ?>
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <?php if($GP['users-add']) { ?>
                ...
                <div class="table-responsive">
                    <table id="UsrTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            ...
                            <th class="col-xs-2"><?php echo lang('user_warehouse'); ?></th>
