<div class="row">
<?php //echo "<pre>";print_r($user);print_r($groups);die; ?>
    <div class="col-sm-2">
        <div class="row">
                    ...
                    <div class="box-content">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <?php $attrib = array('class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form', 'id'=>'edit_user');
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="tel" name="phone" class="form-control" id="phone"
                                                           required="required" value="<?= $user->phone ?>" maxlength="10"/>
                                                </div>
                                            </div>
                                                ...
                                                <div class="controls">  <?php
                                                    ...
                                                    foreach($groups as $key=>$val){
                                                        if(($val['id'] != 1) && ($val['id'] != 2)){
                                                            $grps[$val['id']] = $val['description'];
                                                        }
                                                    }
                                                    echo form_dropdown('group', $grps, (!empty($_POST['group']) ? $_POST['group'] : $user->group_id), 'class="tip form-control" id="group" required="required"');
                                                    ?>
                                                </div>
                                            </div>
                                        <?php }?>
...
<!--            <div id="cpassword" class="tab-pane fade">
    ...
    <script>
        $(document).ready(function () {
                ...
                $("form#edit_user input[type=text]").each(function(){
                    $('#'+$(this).attr('id')).attr('readonly',true)
                });

//                $("form#edit_user select").each(function(){
