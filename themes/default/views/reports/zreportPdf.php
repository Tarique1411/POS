                            ...
                            <div id="receipt-data">
                                ...
                                <div class="row receipthead">
                                    <div class="text-center">
                                        <table class="table table-striped table-bordered" style="border:1px solid #dbdbdb;" cellspacing="0" cellpadding="0">
                                            <tbody>
...
<!--                                                    <tr>
                                                    ...
                                                    <!--tr>
                                                        <td class="text-left"><strong><?= lang("tax_amount"); ?></strong></td>
                                                   ...
                                                   <tr>
                                                        ...
                                                        <td class="text-left">
                                                            <?php 
                                                                ...
                                                                echo $this->sma->formatMoney(abs($tt));  
