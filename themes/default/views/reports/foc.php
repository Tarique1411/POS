<script>
    $(document).ready(function () {
        var oTable = $('#PExData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getFocReports' . ($warehouse_id ? '/' . $warehouse_id : '')) ?>',
            ...
            "aoColumns": [{"bSortable": false, "mRender": checkbox}, null, {"mRender": dateonly}, null, null, null],
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-calendar-o"></i><?= lang('foc'); //. ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')'; ?>
        </h2>
