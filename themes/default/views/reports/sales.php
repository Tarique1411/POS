...
<script>
    $(document).ready(function () {
        ...
        var oTable = $('#SlRData').dataTable({
            ...
            "aoColumns": [{"mRender":dateonly}, null, null, null, /*null, {
                "bSearchable": false,
                "mRender": pqFormat
            ...
            "fnFooterCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
               //console.log(aData);
                ...
                for (var i = 0; i < aData.length; i++) {
                    //console.log("total->",aData[i][4]);
                    gtotal += parseFloat(aData[i][5]);
                    //console.log("gtotal",aData[iDisplayIndexFull[i]]);
                    paid += parseFloat(aData[i][5]);
                    //balance += parseFloat(aData[aiDisplay[i]][7]);
                }
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <?= lang("start_date", "start_date"); ?>
                                    <?php echo form_input('start_date', (isset($_POST['start_date']) ? $_POST['start_date'] : ""), 'class="form-control input-tip date" id="sdate" placeholder="Start Date" required="required" readonly="true"'); ?> 
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <?= lang("end_date", "end_date"); ?>
                                    <?php echo form_input('end_date', (isset($_POST['end_date']) ? $_POST['end_date'] : ""), 'class="form-control input-tip date" id="edate" placeholder="End Date" required="required" readonly="true"'); ?>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php
                                $ptype = array(""=>"--Select--","CC"=>"Credit/Debit Card", "cash"=>"Cash", "gift_card"=>"Credit Note");
                ...
                <div class="table-responsive">
                    <table id="SlRData"
                        ...
                        <tr>
                            ...
                            <th class='col-xs-1'><?= lang("grand_total"); ?> <span class='rupee'>&#8377;</span></th>
                            <th class='col-xs-1'><?= lang("paid"); ?> <span class='rupee'>&#8377;</span></th>
                            
                            <th class='col-xs-2'><?= lang("pay_status"); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
...
<!-- Add by Ankit for date validation -->
<script>    
