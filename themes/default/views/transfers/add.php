...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('Add Purchase Return'); ?></h2>
    </div>
                            ...
                            <div class="well well-sm">
                                <div class="form-group" style="margin-bottom:0;">
                                    <div class="input-group wide-tip">
                                        ...
                                        <?php echo form_input('add_item', '', 'class="form-control input-lg" id="add_item" placeholder="' . $this->lang->line("Please Add Product") . '"'); ?>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                                ...
                                <div class="controls table-controls">
                                    <table id="toTable"
                                        ...
                                        <tr>
                                            ...
                                            // }
                                            ?>
                                            <th class="col-md-2"><?= lang("Invoice Number"); ?></th>
                                            <th class="col-md-2"><?= lang("Invoice Date"); ?></th>
