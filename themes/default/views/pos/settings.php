        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <fieldset class="scheduler-border">
                    ...
                    <!-- Added By Anil For Customized Pos Screen Start -->                    
                     <div class="col-md-4 col-sm-4">
                        <div class="form-group">
                            <?= lang('Enable_full_width', 'enable_full_width'); ?>
                            <?= form_dropdown('enable_full_width', $yn, $pos->isfullWidth, 'class="form-control select" id="enable_full_width" required="required"');
                            ?>
                        </div>
                    </div>
                    <!-- Added By Anil For Customized Pos Screen End --> 
					<div class="col-md-4 col-sm-4">
						...
						<div class="form-group">
							...
							<div class="radio">
								<label class="radio-inline">
									<input type="radio" name="order_discount_type" value="percent" <?php echo ($pos->order_discount_type == 'percent') ? 'checked="checked"' : ''; ?>>Percent
								</label>
								<label class="radio-inline">
									<input type="radio" name="order_discount_type" value="flat" <?php echo ($pos->order_discount_type == 'flat') ? 'checked="checked"' : ''; ?>>Flat
								</label>
							</div>
							<?php
								$attr = array(
									'name' => 'order_discount',
									'id' => 'order_discount',
									'placeholder' => 'Please enter max allowed discount',
									'class'	=> 'form-control',
									'value' => $pos->order_discount
								);
                      ...
                      <!-- Added By Anil Setting permissions for Walking customers pop up start -->                    
                            <div class="col-md-4 col-sm-4">
                                <div class="form-group">
                                    <?= lang('enable_walkcustomer', 'enable_walkcustomer'); ?>
                                    <?= form_dropdown('enable_walkcustomer', $yn, $pos->enable_walkcustomer, 'class="form-control select" id="enable_walkcustomer" required="required"');
                                    ?>
                                </div>
                            </div> 
                            <div class="col-md-4 col-sm-4">
                                <div class="form-group">                                  
                                    <?= lang('return_sales_perioed', 'return_sales_perioed'); ?>
                                    <?= form_input('return_sales_perioed',$pos->return_sales_perioed,'class="form-control tip" id="return_sales_perioed"') ?>
                                </div>
                                <span class="error" id="return_error"></span>
                            </div>
                            
                        <!-- Added By Anil Setting permissions for Walking customers pop up End -->  
					<div class="row">
						<div class="col-lg-12">
							<div class="col-md-4 col-sm-4">
								<div class="form-group">
								<?= lang('Max_Pan_Limit', 'max_pan_limit'); ?>
								<?php
									$attr = array(
										'name' => 'max_pan_limit',
										'id' => 'max_pan_limit',
										'placeholder' => 'Please enter max pan limit',
										'class'	=> 'form-control',
										'value' => $pos->max_pan_limit
									);
									echo form_input($attr);
								?>
							</div>
						</div>
                   <!--Add by ankit for define permission system logout after every payment or not -->
                        <div class="col-md-4 col-sm-4">
                            <div class="form-group">
								<?= lang('logout_after_payment', 'logout_after_payment'); ?>
								
								<?= form_dropdown('logout_after_payment', $yn, $pos->logout_after_payment, 'class="form-control select" id="logout_after_payment" required="required"');
								?>
                            </div>
                        </div>
						<div class="col-md-4 col-sm-4">
							<div class="form-group">
								...
								<?php $yn1 = array(1=>lang('line_item_discount'),2=>lang('invoice_discount'),
							3=>lang('both_discount')); ?>
								<?= form_dropdown('discount_type', $yn1, $pos->discount_type, 'class="form-control select" id="discount_type" required="required"');
                            ?>
							</div>
						</div>
					...
					<div class="row">
                                                ...
                                                <div class="col-md-4 col-sm-4">
                                                    <div class="form-group">
							<?= lang('Return_Sales_All_Stores', 'return_sales_all_stores'); ?>
							<?php $yn1 = array(TRUE=>lang('enable'),FALSE=>lang('disable'));?>
							<?= form_dropdown('return_sales_all_stores', $yn1, $pos->return_sales_all_stores, 'class="form-control select" id="return_sales_all_stores" required="required"');
                            ?>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4 col-sm-4">
                                                    <div class="form-group">
                                                        <?= lang('Accessory_Category', 'accessory_category'); ?>
                                                        <?php
                                                        $ct[''] = '';
                                                        foreach ($categories as $catrgory) {
                                                            $ct[$catrgory->id] = $catrgory->name;
                                                        }
                                                        echo form_dropdown('accessory_category', $ct, $pos->accessory_category, 'class="form-control select" id="accessory_category" required="required"');
                                                        ?>
                                                    </div>
                                                </div>
					</div>
                ...
                <fieldset class="scheduler-border">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            <?= lang('cf_title3', 'tcf3'); ?>
                            <?php echo form_input('cf_title3', $pos->cf_title3, 'class="form-control tip" id="tcf3"'); ?>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            <?= lang('cf_value3', 'vcf3'); ?>
                            <?php echo form_input('cf_value3', $pos->cf_value3, 'class="form-control tip" id="vcf3"'); ?>
                        </div>
                    </div>
                     ...
                     <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            <?= lang('cf_title4', 'tcf4'); ?>
                            <?php echo form_input('cf_title4', $pos->cf_title4, 'class="form-control tip" id="tcf4"'); ?>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            <?= lang('cf_value4', 'vcf4'); ?>
                            <?php echo form_input('cf_value4', $pos->cf_value4, 'class="form-control tip" id="vcf4"'); ?>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            <?= lang('cf_title5', 'tcf5'); ?>
                            <?php echo form_input('cf_title5', $pos->cf_title5, 'class="form-control tip" id="tcf5"'); ?>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            <?= lang('cf_value5', 'vcf5'); ?>
                            <?php echo form_input('cf_value5', $pos->cf_value5, 'class="form-control tip" id="vcf5"'); ?>
                        </div>
                    </div>
                     ...
                     <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            <?= lang('cf_title6', 'tcf6'); ?>
                            <?php echo form_input('cf_title6', $pos->cf_title6, 'class="form-control tip" id="tcf6"'); ?>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            <?= lang('cf_value6', 'vcf6'); ?>
                            <?php echo form_input('cf_value6', $pos->cf_value6, 'class="form-control tip" id="vcf6"'); ?>
                        </div>
                    </div>
                    
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            <?= lang('receipt_declaration','receipt_decl'); ?>
                            <?php echo form_textarea('receipt_declaration', $pos->receipt_declaration, 'class="form-control tip" rows="50" cols="10" id="receipt_decl"'); ?>
                        </div>
                    </div>
                    
                   <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            <?= lang('service_centers','service_cnt'); ?>
                            <?php echo form_textarea('service_centers', $pos->service_centers, 'class="form-control tip" rows="50" cols="10" id="service_cnt"'); ?>
                        </div>
                    </div>
                </fieldset>
                <!--fieldset class="scheduler-border">
...
<script type="text/javascript">
    $(document).ready(function (e) {
		...
		var invoice_discount_type = $("input[name='order_discount_type']:checked").val();
        ...
        $(document).on('keyup blur','#return_sales_perioed',function(){        
                var node = $(this);
                node.val(node.val().replace(/[^0-9]+/i, '') );
                if(node.val() < 1){
                    $("#return_error").text("Enter value greater than 0");
                    $("#return_error").css('color','red');
                    node.val('');
                    //bootbox.alert("Enter value greater than 0");
                    return false;
                }
                else{
                    $("#return_error").text('');
