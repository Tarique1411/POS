    ...
    <head>
        ...
        <style type="text/css" media="all">
            ...
            .border-cover{
                ...
                font-size: 10px;border-bottom:2px solid #DDDDDD;
            }
            hr {
        ...
        <div id="wrapper">
            <div id="receiptData">
                ...
                <div id="receipt-data">
                    ...
                    <div class="row" style="width:auto !important;margin:0px;">
                        <table width="100%" style="border:2px solid #DDDDDD;
                               font-size: 10px;border-bottom:2px solid #DDDDDD;">
                            <tr class="border-bottom">
                                <td colspan="2" align="center" style="border:2px solid #DDDDDD;" height="40"><h5 style="font-weight:bold;"><?= $rows[0]->sale_status == 'foc' ? lang('delivery_challan') : lang('tax_invoice'); ?></h5></td>

                            </tr>
                            <tr>
                                <td height="100" style="border-right:2px solid #DDDDDD;font-size: 10px;border-bottom:2px solid #DDDDDD;border-left:2px solid #DDDDDD;padding:5px;" width="50%">
                                ...
                                <td valign="top" style="font-size: 10px;border-bottom:2px solid #DDDDDD;padding:5px;border-right:2px solid #DDDDDD;border-left:2px solid #DDDDDD;"> 
                            ...
                            <tr >
                                <td valign="top" style="padding: 10px 10px 10px 10px;border-left:2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD!important">
                                    <div style="float: left;font-size: 10px;width:500px"><strong style='font-weight: bold;!important'><?= lang("customer_name"); ?></strong> : <?php echo $inv->customer; ?></div>
                                </td>
                                <td style="border-right: 2px solid #DDDDDD!important;border-bottom: 2px solid #DDDDDD!important">   
                            ...
                            <!--tr>
                                <td colspan="2" style="border:2px solid #DDDDDD;">&nbsp;                        
                                </td>
                            </tr-->

                            <tr>
                                <td colspan="2" style="border-top:2px solid #DDDDDD !important;">
                                    <table class="table table-condensed table-responsive" style="font-size:9px !important;">
                                        <thead>
                                            <tr>
                                                <th rowspan="2" class='text-left' style="padding-left: 6px!important;border-left: 2px solid #DDDDDD;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD; width:2px;">No.</th>
                                                <th rowspan="2" class='text-left' style="padding-left: 6px!important;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD; width:10%;">Reference</th>
                                                <th rowspan="2" rowspan="2" class='text-left' style="padding-left: 6px!important;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;width:15%;">Description</th>
                                                <th rowspan="2" class='text-left' style="padding-left: 6px!important;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;width:3%;">HSN Code</th>
                                                <th rowspan="2" class='text-left' style="padding-left: 6px!important;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD; width:4%;"><?= lang("mrp"); ?><span class="rupee">&#8377;</span></th>
                                                <?php if ($rows[0]->sale_status != 'foc') {
                                                    ?>
                                                    <th rowspan="2" class='text-left' style="padding-left: 6px!important;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;" width="3%">Discount&#8377;</th>
                                                    <?php
                                                }
                                                ?>
                                                <th rowspan="2" class='text-left' style="padding-left: 6px!important;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;width:1px;"><?= lang("qty"); ?></th>
                                                <th rowspan="2" class='text-left' style="padding-left: 6px!important;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;width:10px;"><?= lang("price") . '&#8377;'; ?></th>
                                                <th class='text-left' width="10%" style="padding-left: 6px!important;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;height:20px;" ><?= lang("cgst"); ?></th>
                                                <th class='text-left' style="padding-left: 6px!important;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;height:20px;" width="15%"><?= lang("sgst"); ?></th>
                                                <th rowspan="2" class='text-left' style="padding-left: 6px!important;border-bottom: 2px solid #DDDDDD;border-right: 2px solid #DDDDDD;" width="9%"><?= lang("total") . '&#8377;'; ?></th>
                                            </tr>
                                            <tr style="border-bottom: 2px solid #DDDDDD">
                                                <td style="border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;padding: 0px !important">
                                                    <table width="100%" style="height: 34px;" >
                                                        <tr>
                                                            <td style="border-right: 2px solid #DDDDDD;white-space: nowrap !important;height:20px;" width="30%">
                                                                <div style="padding:9px;"><?= lang("rate") . '%'; ?> </div>
                                                                <!--div style="padding:9px;"><?php echo "%"; ?></div-->
                                                            </td>
                                                            <!--<td> --> 
                                                            <td style="border-right: 2px solid #DDDDDD;height:20px;" width="70%">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($rows as $row) {
                                                ...
                                                if ($row->return_id != 0) {
                                                    echo '<tr style="border-bottom:2px solid #DDDDDD">'
                                                    . '<td class="text-left border-right" style="padding-left: 6px!important;border-left: 2px solid #DDDDDD;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;">' . $r . '</td>'
                                                    . '<td class="text-left border-right" style="padding-left: 6px!important;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;">' . ($row->product_code) . ($row->variant ? ' (' . $row->variant . ')' : '') . '</td>'
                                                    . '<td class="text-left border-right" style="padding-left: 6px!important;width:20%;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;">' . $row->product_name . '</td>'
                                                    . '<td class="text-left border-right"  style="padding-left: 6px!important;width:3%;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;">' . $row->hsn_code . '</td>'
                                                    . '<td class="text-left border-right"  style="padding-left: 6px!important;width:4%;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;">' . $this->sma->formatMoney($row->real_unit_price) . '</td>';
                                                    if ($row->sale_status != 'foc') {
                                                        echo
                                                        '<td class="text-left border-right"  style="padding-left: 6px!important;width:20%;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;">' . $this->sma->formatMoney($disc) . '</td>';
                                                    }
                                                    echo '<td class="text-left border-right"  style="padding-left: 6px!important;width:20%;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;">' . round($row->quantity) . '</td>'
                                                    . '<td class="text-left"  style="padding-left: 6px!important;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;">' . ($row->sale_status != 'foc' ? $this->sma->formatMoney($row->net_unit_price) : 0) . '</td>'
                                                    . '<td class="text-left border-right" style="padding-left: 6px!important;padding:0px !important;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;">
<table width="100%" height="52px">
    <tr><td valign="top" class="border-right" width="38%" style="text-align:left; border-right: 2px solid #DDDDDD;">' . ($row->tax_rate / 2) . ''
     . '</td><td valign="top" class="text-left" style="text-align:left;">' . $this->sma->formatMoney($row->item_tax / 2) . '</td></tr>
</table>
                                            </td>'
                                                    . '<td class="text-left border-right" style="padding:0px !important;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;">
<table width="100%" height="52px">
    <tr><td valign="top" class="border-right" width="38%" style="text-align:left; border-right: 2px solid #DDDDDD;padding-top:6px;padding-left:6px;">' . ($row->tax_rate / 2) . '</td>'
    . '<td valign="top" class="text-left" style="text-align:left;padding-top:6px;padding-left:6px;">' . $this->sma->formatMoney($row->item_tax / 2) . '</td></tr>
</table>
                                                    </td>'

                                                    //                        . '<td class="text-left">' . $prod_amount . '</td>'
                                                    . '<td class="" style="padding-left: 6px!important;text-align:left;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;">' . $this->sma->formatMoney($row->pdiscount_type == 'foc' ? 0 : $row->real_unit_price-$row->item_discount) . '</td>'
                                                    . '</tr>';
                                                } else {
                                                    echo '<tr style="border-bottom:2px solid #DDDDDD">'
                                                    . '<td class="text-left border-right" style="padding-left: 6px!important;border-left: 2px solid #DDDDDD;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;" >' . $r . '</td>'
                                                    ...
                                                    . '<td class="text-left border-right"  style="padding-left: 6px!important;width:4%;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;">' . $this->sma->formatMoney($row->real_unit_price) . '</td>';
                                                    if ($row->sale_status != 'foc') {
                                                        echo '<td class="text-left border-right" style="padding-left: 6px!important;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;">' . $this->sma->formatMoney($disc) . '</td>';
                                                    }
                                                    echo '<td class="text-left border-right" style="padding-left: 6px!important;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;">' . round($row->quantity) . '</td>'
                                                    . '<td class="text-left border-right" style="padding-left: 6px!important;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;">' . ($row->sale_status != 'foc' ? $this->sma->formatMoney($row->net_unit_price) : 0) . '</td>'
                                                    . '<td class="text-left border-right" style="padding-left: 6px!important;padding:0px !important;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;">
<table width="100%" height="52px">
    <tr><td valign="top" class="border-right" width="36%" style="text-align:left; border-right: 2px solid #DDDDDD;padding-top:6px;padding-left:6px;">' . ($row->tax_rate / 2) . '</td>'
     . '<td valign="top" class="text-left" style="text-align:left;padding-top:6px;padding-left:6px;">' . $this->sma->formatMoney($row->item_tax / 2) . '</td></tr>
</table>
                                                    </td>'
                                         . '<td  class="text-left border-right" style="padding:0px !important;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;">
<table width="100%" height="52px" >
        ...
        . '<td valign="top" class="text-left" style="text-align:left;padding-top:6px;padding-left:6px;">' . $this->sma->formatMoney($row->item_tax / 2) . '</td></tr>
                                                    ...
                                                    //                        . '<td class="text-left">' . $prod_amount . '</td>'
                                                    . '<td valign="top" class="" style="padding-left: 6px!important;text-align:left;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;">' . $this->sma->formatMoney($row->pdiscount_type== 'foc' ? 0 : $row->real_unit_price-$row->item_discount) . '</td>'
                                                    . '</tr>';
                                                }
                                            ...
                                            ?>
                                            <tr><td colspan="11" height="50px;" style="border:2px solid #DDDDDD">&nbsp;</td></tr>
                                            <tr style="border:2px solid #DDDDDD">
                                                ...
                                                <td class='text-left border-right' style="padding-left:6px!important;"><?php echo $this->sma->formatMoney(round($total_mrp)) ?></td>
                                                <!--<th class="text-right"><?= $this->sma->formatMoney($inv->total + $inv->product_tax) ?></th>-->
                                            </tr>
                                            <tr>
                                                <td colspan="6" style="border-left:2px solid #DDDDDD;border-right:2px solid #DDDDDD;border-bottom:2px solid #DDDDDD;">

                                                    <?php
//echo "<pre>";print_r($payments);exit;
                                                    if ($payments) {
                                                        echo '<table class="table table-condensed" style="border:none !important;width:50%"><tbody>';
                                                        echo '<tr><th style="border:none !important;padding-left:6px!important;">Payment Mode</th><th style="border:none !important;">Amount <span class="rupee">&#8377;</span></th></tr>';
                                                ...
                                                <td colspan="5" style="border-left:2px solid #DDDDDD;border-right:2px solid #DDDDDD;border-bottom:2px solid #DDDDDD;padding-left:<?= $inv->sale_status == 'foc'?93:100?>px!important;" >
                                                    <p>&nbsp;</p>
                                                    <div style="height: auto;float: right;">
                                                        <div style="height:10px;"><span>&nbsp;&nbsp;</span><span><?= lang("taxable_amount") . '<b>&#8377;</b>'; ?></span> <span style="color:white"><?= lang("taxable_amount"); ?>---</span> <span class="text-right"><?= $this->sma->formatMoney($total_basic_price) ?></span></div>
                                                        <?php foreach ($tax_value as $keys => $rows) {
                                                            ?>
                                                            <div style="height:10px;"><span>&nbsp;&nbsp;</span><span><?= lang("sgst"); ?>@ <?php echo round($keys / 2) ?> %</span><span style="color:white"><?= lang("taxable_amount"); ?>----------</span> <span class="text-right"><?php echo $this->sma->formatMoney($rows) ?></span></div>
                                                            <div style="height:10px;"><span>&nbsp;&nbsp;</span><span><?= lang("cgst"); ?>@ <?php echo round($keys / 2) ?> % </span><span style="color:white"><?= lang("taxable_amount"); ?>---------</span> <span class="text-right"><?php echo $this->sma->formatMoney($rows) ?></span></div>

                                                            <?php
                                                        }
                                                        ?>
                                                        <div style="height:10px;"><span>&nbsp;&nbsp;</span><span style=""><?= lang("total_amount") . '<b>&#8377;</b>'; ?></span><span style="color:white"><?= lang("taxable_amount"); ?>--------</span> <span class="text-right"><?php echo $this->sma->formatMoney(round($total_mrp)) ?></span></div>
                                                        <div>&nbsp;</div>
...
//echo "<pre>";print_r($inv);
                                       ...
                                       <!--  <tr>
                                            <th colspan="11" class="text-left"><?= lang("net_amount"); ?>&nbsp;<span class="rupee">&#8377;</span></th>   
                                                ...
                                                <?php if ($inv->grand_total > 0) { ?>
                                                    <tr style="">
                                                        <th colspan="11" height="30px" class="text-left" style="font-size: 13px;border-left:2px solid #DDDDDD;border-right:2px solid #DDDDDD;border-bottom:2px solid #DDDDDD;padding-left: 6px!important;"><span><?= lang("amount_chargeable_words") . ':'; ?> </span>  
                                                            <?php
            ...
            <!--                        <th class="text-left" colspan="11"><?= $this->sma->formatMoney($inv->grand_total + $rounding) ?></th>-->
                                        <!-- <tr>
                                            ...
                                            <tr>
                                                <th colspan="11" style="border-right:2px solid #DDDDDD;border-bottom:2px solid #DDDDDD;border-left:2px solid #DDDDDD;padding-left: 6px!important;">
                                        <p>&nbsp;</p>
