    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <table width="100%" class="stable">
                <tr>
                    <td style="border-bottom: 1px solid #EEE;"><h4><?= lang('cash_in_hand').' (today\'s)'; ?>:</h4></td>
                    <td style="text-align:right; border-bottom: 1px solid #EEE;"><h4>
                            <span><?= $this->sma->formatMoney($opening_balance[0]->cash_in_hand); ?></span></h4>
                    </td>
                </tr>
                <tr>
...
<!--                <tr>
                ...
                <tr>
                    <td style="border-bottom: 1px solid #DDD;"><h4><?= lang('dc_sale'); ?>:</h4></td>
                    <td style="text-align:right;border-bottom: 1px solid #DDD;"><h4>
                            <span><?= $this->sma->formatMoney($dcsales->paid ? $dcsales->paid : '0.00'); ?></span>
                        </h4></td>
                </tr>
                
                <tr>
                    <td style="border-bottom: 1px solid #DDD;"><h4><?= lang('cn_sale'); ?>:</h4></td>
                    <td style="text-align:right;border-bottom: 1px solid #DDD;"><h4>
                            <span><?= $this->sma->formatMoney($cnsales->paid ? $cnsales->paid : '0.00'); ?></span>
                        </h4></td>
                </tr>
                <?php if ($pos_settings->paypal_pro) { ?>
                    <tr>
                        ...
                        <td style="text-align:right;border-bottom: 1px solid #DDD;"><h4>
                                <span><?= $this->sma->formatMoney($pppsales->total ? $pppsales->total : '0.00') . ' (' . $this->sma->formatMoney($pppsales->total ? $pppsales->total : '0.00') . ')'; ?></span>
                            </h4></td>
                    </tr>
                <?php } ?>
                <?php if ($pos_settings->stripe) { ?>
                    <tr>
                        ...
                        <td style="text-align:right;border-bottom: 1px solid #DDD;"><h4>
                                <span><?= $this->sma->formatMoney($stripesales->total ? $stripesales->total : '0.00') . ' (' . $this->sma->formatMoney($stripesales->total ? $stripesales->total : '0.00') . ')'; ?></span>
                            </h4></td>
                    </tr>
                <?php } ?>
                <tr>
                    ...
                    <td width="200px;" style="text-align:right;"><h4 style="font-weight:bold;">
                            <span><?= $this->sma->formatMoney($totalsales->total ? $totalsales->paid : '0.00'); ?></span>
                        </h4></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align:right;"><h4>
                            <span><strong><?= $cashsales->paid ? $this->sma->formatMoney(($cashsales->paid + ($opening_balance[0]->cash_in_hand)) - $expense) : $this->sma->formatMoney($this->session->userdata('cash_in_hand') - $expense); ?></strong></span>
                        </h4></td>
                </tr>
            </table>
        </div>
