                                    ...
                                    <table class="table table-condensed table-responsive" style="font-size:9px !important;">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($rows as $row) {
                                                ...
                                                $total_basic_price += $row->pdiscount_type ? 0 : $row->net_unit_cost;
...
<table width="100%" height="52px">
    <tr><td valign="top" class="border-right" width="30%" style="text-align:left; border-right: 2px solid #DDDDDD;">' . ($row->tax_rate / 2) . ''
...
<table width="100%" height="52px">
    <tr><td valign="top" class="border-right" width="30%" style="text-align:left; border-right: 2px solid #DDDDDD;padding-top:6px;padding-left:6px;">' . ($row->tax_rate / 2) . '</td>'
    . '<td valign="top" class="text-left" style="text-align:left;padding-top:6px;padding-left:6px;">' . $this->sma->formatMoney($row->item_tax / 2) . '</td></tr>
                                                    ...
                                                    . '<td class="" style="padding-left: 6px!important;text-align:left;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;">' . $this->sma->formatMoney($row->pdiscount_type ? 0 : $row->real_unit_price) . '</td>'
                                                    . '</tr>';
                                                } else {
                                                    echo '<tr style="border-bottom:2px solid #DDDDDD">'
                                                    . '<td class="text-left border-right" style="padding-left: 6px!important;border-left: 2px solid #DDDDDD;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;" >' . $r . '</td>'
                                         ...
                                         . '<td  class="text-left border-right" style="padding:0px !important;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;">
                                                <table width="100%" height="52px" >
                                                    ...
                                                    //                        . '<td class="text-left">' . $prod_amount . '</td>'
                                                    . '<td valign="top" class="" style="padding-left: 6px!important;text-align:left;border-right: 2px solid #DDDDDD;border-bottom: 2px solid #DDDDDD;">' . $this->sma->formatMoney($row->pdiscount_type ? 0 : $row->real_unit_price) . '</td>'
                                                    . '</tr>';
                                                }
                                            ...
                                            <tr style="border:2px solid #DDDDDD">
                                                ...
                                                <td class='text-left border-right' style="padding-left:6px!important;"><?php echo $this->sma->formatMoney($total_mrp) ?></td>
...
//echo "<pre>";print_r($payments);exit;
                                                ...
                                                <td colspan="5" style="border-left:2px solid #DDDDDD;border-right:2px solid #DDDDDD;border-bottom:2px solid #DDDDDD;padding-left:<?= $inv->sale_status == 'foc'?93:100?>px!important;" >
                                                    ...
                                                    <div style="height: auto;float: right;">
                                                        ...
                                                        ?>
                                                        <div style="height:10px;"><span>&nbsp;&nbsp;</span><span style=""><?= lang("total_amount") . '<b>&#8377;</b>'; ?></span><span style="color:white"><?= lang("taxable_amount"); ?>--------</span> <span class="text-right"><?php echo $this->sma->formatMoney($total_mrp) ?></span></div>
                                                        <div>&nbsp;</div>
                                                   ...
                                                   <!--  <table style="width: 1400px;border:2px solid #000000;">
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td><?= lang("total_amount"); ?></td><td><?php echo $this->sma->formatMoney($total_mrp) ?></td>
                                                        </tr>
                                                        </tbody>
                                                    </table> -->
                                                </td>
