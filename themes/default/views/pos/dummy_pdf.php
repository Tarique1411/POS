...
<div id="wrapper">
  <div id="receiptData">
    ...
    <div id="receipt-data">
      <div class="text-center" style="height:30px;"> <img src="<?= base_url() . 'assets/uploads/logos/' . $biller->logo; ?>" 
                             alt="<?= $biller->company; ?>" style="height:20px;"> </div>
      ...
      <div class="row" style="width:auto !important;margin:0px;">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="top"><h5 style="font-weight:bold;">
                <?= $rows[0]->sale_status == 'foc' ? lang('delivery_challan') : lang('tax_invoice'); ?>
              </h5></td>
          </tr>
          <tr>
            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="100" style="font-size: 10px;border-bottom:1px solid #DDDDDD;border-left:1px solid #DDDDDD;padding:5px;" width="50%"><div style="padding:10px 10px 10px 10px">
                      <p><strong style="font-weight: bold;!important">
                        <?= lang("store_name") . ':'; ?>
                        </strong> <?php echo $biller->company; ?>&nbsp;.</p>
                      <p style="text-transform: capitalize"><strong style="font-weight: bold;!important">
                        <?= lang("store_address") . ':'; ?>
                        </strong> <?php echo $biller->address . "&nbsp;" . strtolower($biller->city) . "-&nbsp;" . $biller->postal_code . ",&nbsp;" . strtolower($biller->state) ?></p>
                      <p><strong style="font-weight: bold;!important">
                        <?= lang("pan_no") . ':'; ?>
                        </strong> <?php echo $biller->tin_no ?></p>
                      <p><strong style="font-weight: bold;!important">
                        <?= lang("gstin_no") . ':'; ?>
                        </strong> <?php echo $biller->vat_no ?></p>
                    </div></td>
                  <td valign="top" style="font-size: 10px;border-bottom:1px solid #DDDDDD;padding:5px;border-right:1px solid #DDDDDD;border-left:1px solid #DDDDDD;"><div style="padding:10px 10px 10px 10px;padding-top:0px;">
                      <?php
                      ...
                      <p><strong style='font-weight: bold;!important'>
                        <?= lang("supply_place") . ':'; ?>
                        </strong> <?php echo ucwords(strtolower($biller->state)) ?></p>
                      <p><strong style='font-weight: bold;!important'>
                        <?= lang("state_code") . ':'; ?>
                        </strong> <?php echo $biller->state_id ?></p>
                    </div></td>
                </tr>
              </table></td>
          </tr>
          <tr>
            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td valign="top"  width="45%"><div style="float: left;font-size: 10px;"><strong style='font-weight: bold;!important'>
                      <?= lang("customer_name"); ?>
                      </strong> : <?php echo $inv->customer; ?></div></td>
                  <td style="" width="45%"><div style="font-size: 10px;float:right"><strong style='font-weight: bold;!important'>
                      <?= lang("customer_contact"); ?>
                      </strong> : <?php echo ($inv->sale_status === 'foc') ? $foc_details->mobile : $customer->phone; ?></div></td>
                </tr>
              </table></td>
          </tr>
          <tr>
      ...
      <tr>
          ...
          <td colspan="2" ><table class="table table-condensed table-responsive" style="font-size:9px !important;">
              <thead>
                <tr>
                  ...
                  <th rowspan="2" class='text-left' style="padding-left: 3px!important;border-right: 1px solid #DDDDDD;border-bottom: 1px solid #DDDDDD; width:10%;">Reference</th>
                    <th rowspan="2" rowspan="2" class='text-left' style="padding-left: 3px!important;border-right: 1px solid #DDDDDD;border-bottom: 1px solid #DDDDDD;width:23%;">
                  Description
                    </th>
                  ...
                  <th rowspan="2" class='text-left' style="padding-left: 3px!important;border-right: 1px solid #DDDDDD;border-bottom: 1px solid #DDDDDD; width:10%;"><?= lang("mrp"); ?>
                    <span class="rupee">&#8377;</span></th>
                ...
                <tr >
                  <td style="border-right: 1px solid #DDDDDD;border-bottom: 1px solid #DDDDDD;padding: 0px !important"><table width="100%" style="height: 34px;" >
                      <tr>
                        <td style="border-right: 1px solid #DDDDDD;white-space: nowrap !important;height:20px;padding: 0px 1px 0px 1px;" width="30px"><div style="padding:9px;">
                            <?= lang("rate") . '%'; ?>
                          </div>
                          
                          <!--div style="padding:9px;"><?php echo "%"; ?></div--></td>
                        <!--<td> -->
                        <td style="height:20px;padding-left: 3px!important;" width="70%"><div style="padding:9px;">
                            <?= lang("amt") . '&#8377;'; ?>
                          </div></td>
                      </tr>
                    </table></td>
...
<table width="100%" height="52px">
    <tr>
    <td nowrap valign="top" class="border-right" width="30px" style="text-align:left; border-right: 1px solid #DDDDDD; padding-left:6px;">' . ($row->tax_rate / 2) . ''
                                                    . '</td>'
                                                    . '<td nowrap valign="top" width="100px" class="text-left" style="text-align:left; ">' . $this->sma->formatMoney($row->item_tax / 2) . '</td></tr>
</table>
                                            </td>'
...
<table width="100%" height="" style="margin:0px; padding:0px; border:1px;" >
        ...
        <td valign="top" class="border-right" width="30px" style="text-align:left; border-right: 1px solid #DDDDDD;padding-left:6px; white-space:nowrap !important">' . ($row->tax_rate / 2) . '</td>'
                                                    ...
                                                    //                        . '<td class="text-left">' . $prod_amount . '</td>'
                                                    . '<td valign="" class="" style="padding-left: 3px!important; padding-top: 3px!important; padding-bottom: 3px!important;text-align:left;border-right: 1px solid #DDDDDD;border-bottom: 1px solid #DDDDDD; text-align:right; padding-right:20px;">' . $this->sma->formatMoney($row->pdiscount_type == 'foc' ? 0 : $row->real_unit_price - $row->item_discount) . '</td>'
                                                    . '</tr>';?>
      ...
      <tr>
                  ...
                  <td class="text-left" height="30px"  style="padding-left:6px!important;"><?= lang("total") . '<b>&#8377;</b>'; ?>
                  ...
                  <table  width="100%">
                      <tr>
                        <td width="30%">&nbsp;</td>
                        <td class="text-left" style="padding-left:6px!important;"><?= $this->sma->formatMoney($total_item_tax) ?></td>
                      </tr>
                    </table></td>
                  <td>
                  <table width="100%">
          ...
          <tr>
            <td align="left" valign="top"><table width="100%" style="width:100% !important;">
                      <tr>
                        <td width="50%"  style="border-left:1px solid #DDDDDD;border-right:1px solid #DDDDDD;border-top:1px solid #DDDDDD;border-bottom:1px solid #DDDDDD; padding-top: 6px!important;"><?php
//echo "<pre>";print_r($payments);exit;
          ...
          <tr>
            <td align="left" valign="top"> <table>
                <tr>
                  <td colspan="11" style="border:solid 1px #000000; " > </td>
                        <td width="20%"  colspan="2" style="padding-left: 10px!important;border-top:1px solid #DDDDDD;border-bottom:1px solid #DDDDDD;padding-top: 6px!important;padding-bottom: 6px!important; vertical-align: top; text-align: right;"><?= lang("taxable_amount") . '<b>&#8377;</b>'; ?>
                          <br/>
                          <?= lang("sgst"); ?>
                          @<?php echo round(key($tax_value) / 2) ?> %<br/>
                          <?= lang("cgst"); ?>
                          @<?php echo round(key($tax_value) / 2) ?> %<br/>
                          <?= lang("total_amount") . '<b>&#8377;</b>'; ?></td>
                        <td width="20%"  style="padding-right: 20px!important;border-right:1px solid #DDDDDD;border-top:1px solid #DDDDDD;border-bottom:1px solid #DDDDDD;padding-top: 6px!important;padding-bottom: 6px!important; text-align: right; vertical-align: top; "><?= $this->sma->formatMoney($total_basic_price) ?>
                          <br/>
                          <?= $this->sma->formatMoney($tax_value[key($tax_value)]) ?>
                          <br/>
                          <?= $this->sma->formatMoney($tax_value[key($tax_value)]) ?>
                          <br/>
                          <?php echo $this->sma->formatMoney(round($total_mrp)) ?></td>
                        <!--td colspan="5" style="border-left:1px solid #DDDDDD;border-right:1px solid #DDDDDD;" >
                                                                <div style="width:100% !important; float:left;">
                                                                    ...
                                                                    <div style="width:50%!important; float:left;">  
                                                                        ...
                                                                        <div style="height:15px; width: 100%; float: left;"><span style="width:50%; float: left;"><?= lang("taxable_amount") . '<b>&#8377;</b>'; ?></span>  <span style="width:50%; float: left; text-align: right; padding-right: 20px;"><?= $this->sma->formatMoney($total_basic_price) ?></span></div>
                                                            <?php foreach ($tax_value as $keys => $rows) {
                                                                ?>
                                                                                <div style="height:15px; width: 100%; float: left;"><span style="width:50%; float: left;"><?= lang("sgst"); ?>@ <?php echo round($keys / 2) ?> %</span> <span style="width:50%; float: left; text-align: right; padding-right: 20px;"><?php echo $this->sma->formatMoney($rows) ?></span></div>
                                                                                <div style="height:15px; width: 100%; float: left;"><span style="width:50%; float: left;"><?= lang("cgst"); ?>@ <?php echo round($keys / 2) ?> % </span> <span style="width:50%; float: left; text-align: right; padding-right: 20px;"><?php echo $this->sma->formatMoney($rows) ?></span></div>
...
//echo "<pre>";print_r($inv);
                ...
                <?php if ($inv->grand_total > 0) { ?>
                <tr style="">
                  <th colspan="11" height="30px" class="text-left" style="font-size: 13px;border-left:1px solid #DDDDDD;border-right:1px solid #DDDDDD;border-bottom:1px solid #DDDDDD;padding-left: 3px!important;"><span>
                    <?= lang("amount_chargeable_words") . ':'; ?>
                    </span>
                    <?php
                ...
                <tr style="width:100%;">
                  <td colspan="11" style="border-left:1px solid #DDDDDD; border-right:1px solid #DDDDDD; border-bottom:1px solid #DDDDDD;padding-left: 3px!important; padding-top: 3px!important; padding-bottom: 3px!important;"><table style="width:100%">
                      <tr>
                        <th style="width:70%"><?= lang("paid_amount"); ?></th>
                        <th class=""  style="width:30%; text-align: right; padding-right: 20px;"><?= $this->sma->formatMoney($inv->paid); ?></th>
                      </tr>
                      <tr>
                        <th  style="width:70%"><?= lang("due_amount"); ?></th>
                        <th class="text-left" style="width:30%; text-align: right; padding-right: 20px;"><?= $this->sma->formatMoney($inv->grand_total - $inv->paid); ?></th>
                      </tr>
                    </table></td>
                </tr>
                <?php } ?>
              ...
              <tfoot>
                <tr>
                  <th colspan="11" style="border-right:1px solid #DDDDDD;border-bottom:1px solid #DDDDDD;border-left:1px solid #DDDDDD;padding-left: 3px!important;"> <p>&nbsp;</p>
                    <h5 class="" style="font-size: 9px;">Declaration: </h5>
                    <p class="declaration" style="font-size: 9px;font-weight:normal;">1. We declare that this
                      <?= $inv->sale_status == 'foc' ? 'delivery challan' : 'invoice' ?>
                      shows the actual price of the goods described and that all particulars are true and correct.</p>
                    ...
                    <div style="height:30px;width:900px;text-align:right">
                      ...
                      <div style="color:white">---------------------------------------------------------------------------------------------------------------------------------------------------------------------- <span style="color:#000000">(Authorised Signatory) </span> </div>
                      <div style="color:white">-------------------------------------------------------------------------------------------------------------------------------------------------------------- <span style="color:#000000">Swatch Group (India) Retail Pvt. Ltd. </span>
                        <p>&nbsp;</p>
                      </div>
                    </div>
                  </th>
      ...
      <div class="well well-sm" style="font-size:9px !important;border: 1px solid #ddd; background-color: #f6f6f6;">
        <h6 class="text-center"><strong>
          <?= $pos_settings->cf_title3 ?>
          </strong></h6>
        <p class="text-center declaration"><strong>Registered Office: </strong>
          <?= $pos_settings->cf_value3 ?>
        </p>
        <p class="text-center declaration"><strong>
          <?= $pos_settings->cf_title4 ?>
          : </strong>
          <?= $pos_settings->cf_value4 ?>
        </p>
        <p class="text-center declaration"><strong>
          <?= $pos_settings->cf_title5 ?>
          : </strong>
          <?= $pos_settings->cf_value5 ?>
        </p>
        <p class="text-center declaration"><strong>
          <?= $pos_settings->cf_title6 ?>
          : </strong>
          <?= $pos_settings->cf_value6 ?>
        </p>
      </div>
    </div>
    <div style="clear:both;"></div>
  ...
  <div id="buttons" style="padding-top:10px; text-transform:uppercase;" class="no-print">
    ...
    <span class="col-xs-12"><a class="btn btn-block btn-primary" onClick="printReceipt()">
    <?= lang("print"); ?>
    </a></span> <span class="col-xs-12"><a class="btn btn-block btn-info" type="button" onClick="openCashDrawer()">Open Cash
    Drawer</a></span>
    <div style="clear:both;"></div>
    <?php } else { ?>
    <span class="pull-right col-xs-12"> <a href="javascript:window.print()" id="web_print" class="btn btn-block btn-primary"
                               onClick="window.print();
                                               return false;">
    <?= lang("web_print"); ?>
    </a> </span>
    <?php } ?>
    <span class="pull-left col-xs-12"><a class="btn btn-block btn-success" href="<?= site_url('pos/save_invoice_pdf/' . $sid); ?>" >
    <?= lang("save_as_pdf"); ?>
    </a></span> <span class="col-xs-12"> 
    <!--Add logout functionality after payment @ ankit-->
    <?php if ($pos_settings->logout_after_payment == '1') { ?>
    <a class="btn btn-block btn-warning" href="<?= site_url('auth/logout'); ?>">
    <?= lang("back_to_pos"); ?>
    </a>
    <?php } else { ?>
    <a id="back_to_pos" class="btn btn-block btn-warning" href="<?= site_url('pos'); ?>">
    <?= lang("back_to_pos"); ?>
    </a>
    <?php } ?>
    </span>
