    ...
    <div id="receipt-data">
        ...
        <div class="row" style="width:auto !important;margin:0px;">
           <table width="100%" style="border:2px solid #DDDDDD">
                ...
                <tr>
                    <td style="border-right:2px solid #DDDDDD;font-size: 10px;border-bottom:2px solid #DDDDDD;" width="50%">
                    ...
                    <td valign="top"  style="font-size: 10px;border-bottom:2px solid #DDDDDD;"> 
                        <div style="padding:10px 10px 10px 10px;"> 
                        <?php
                            ...
                            ?>
                            <p><strong><?= lang("supply_place"); ?></strong>  :  <?php echo $biller->state?></p>
                ...
                <tr >
                    <td colspan="2" style="padding: 10px 10px 10px 10px;">
                        <div style="float: left;font-size: 10px;width:50%"><strong><?= lang("customer_name"); ?></strong> : <?php echo $inv->customer;?></div>
                        <div style="font-size: 10px;"><strong><?= lang("customer_contact"); ?></strong> : <?php echo ($inv->sale_status === 'foc') ? $foc_details->mobile:$customer->phone; ?></div>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" style="border-bottom:2px solid #DDDDDD;">&nbsp;                        
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="2">
                        <table class="table table-condensed table-responsive" style="font-size:9px !important;">
                            <thead>
                                <tr>
                                    <th rowspan="2" class='text-left' style="border-right: 2px solid #DDDDDD;" width="5%">S. No.</th>
                                    <th rowspan="2" class='text-left' style="border-right: 2px solid #DDDDDD;" width="10%">Reference No</th>
                                    <th rowspan="2" rowspan="2" class='text-left' style="border-right: 2px solid #DDDDDD;" width="10%">Description</th>
                                    <th rowspan="2" class='text-left' style="border-right: 2px solid #DDDDDD;" width="5%">HSN Code</th>
                                    <th rowspan="2" class='text-left' style="border-right: 2px solid #DDDDDD;" width="10%"><?= lang("mrp"); ?><span class="rupee">&#8377;</span></th>
                                    <?php if($rows[0]->sale_status!='foc'){
                                    ?>
                                    <th rowspan="2" class='text-left' style="border-right: 2px solid #DDDDDD;" width="5%">Discount</th>
                                    <?php
                                    }
                                    ?>
                                    <th rowspan="2" class='text-left' style="border-right: 2px solid #DDDDDD;" width="5%"><?= lang("qty"); ?></th>
                                    <th rowspan="2" class='text-left' style="border-right: 2px solid #DDDDDD;" width="10%"><?= lang("price"); ?></th>
                                    <th class='text-left' style="border-right: 2px solid #DDDDDD;" width="15%" ><?= lang("cgst"); ?></th>
                                    <th class='text-left' style="border-right: 2px solid #DDDDDD;" width="15%"><?= lang("sgst"); ?></th>
                                    <th rowspan="2" class='text-left' style="border-bottom: 2px solid #DDDDDD;" width="10%"><?= lang("total"); ?></th>
                                    </tr>
                                    <tr style="border-bottom: 2px solid #DDDDDD">
                                    <td style="border-right: 2px solid #DDDDDD;padding: 0px !important">
                                        <table width="100%" style="height: 34px;" >
                                            <tr>
                                                <td style="border-right: 2px solid #DDDDDD;" width="50%">
                            ...
                            <tbody>
                                ...
                                foreach ($rows as $row) {
                                    ...
                                    if($row->return_id != 0){
                                        ...
                                        . '<td class="text-left border-right" style="border-right: 2px solid #DDDDDD;">' .$r.'</td>'
                                        . '<td class="text-left border-right" style="border-right: 2px solid #DDDDDD;">' .($row->product_code). ($row->variant ? ' (' . $row->variant . ')' : '').'</td>'
                                        . '<td class="text-left border-right" style="width:20%;border-right: 2px solid #DDDDDD;">'.$row->product_name.'</td>'
                                        . '<td class="text-left border-right;border-right: 2px solid #DDDDDD;">'.$row->hsn_code.'</td>'
                                        .'<td class="text-left border-right;border-right: 2px solid #DDDDDD;">'.$this->sma->formatMoney($row->real_unit_price).'</td>';
                                         if($row->sale_status!='foc'){
                                        
                                        echo '<td class="text-left border-right" style="border-right: 2px solid #DDDDDD;">' .$this->sma->formatMoney($disc). '</td>';
                                    }

                                       echo '<td class="text-left border-right" style="border-right: 2px solid #DDDDDD !important;">' .round($row->quantity). '</td>'
                                         .'<td class="text-left border-right" style="">'.($row->sale_status!='foc'?$this->sma->formatMoney($row->net_unit_cost):0).'</td>'
                                         . '<td class="text-left border-right tax_tb" style="padding:0px !important;">
                                            <table width="100%" style="">
                                            <tr><td class="border-right" width="50%" style="text-align:left;padding-left:3px;">'.($row->tax_rate/2).'</td><td class="text-right" style="text-align:left;padding-left:3px;">'.$this->sma->formatMoney($row->item_tax/2).'</td></tr></table>
                                            </td>'
                                       . '<td class="text-left border-right tax_tb1" style="padding:0px !important;border-right: 2px solid #DDDDDD !important;">
                                            <table width="100%" style="">
                                            <tr><td class="border-right" width="50%" style="text-align:left;padding-left:3px;">'.($row->tax_rate/2).'</td><td class="text-left" style="text-align:left;padding-left:3px;">'.$this->sma->formatMoney($row->item_tax/2).'</td></tr></table>
                                            </td>'
                //                        . '<td class="text-left">' . $prod_amount . '</td>'
                                          .'<td class="text-left border-right" style="border-right: 2px solid #DDDDDD;">'.$this->sma->formatMoney($row->real_unit_price-$row->item_discount).'</td>'
                                        . '</tr>';
                                    }
                                    else{
                                        echo '<tr style="border-bottom:2px solid #DDDDDD">'
                                         . '<td class="text-left" style="border-right: 2px solid #DDDDDD !important;">' .$r.'</td>'
                                        . '<td class="text-left" style="border-right: 2px solid #DDDDDD !important;">' . ($row->product_code). ($row->variant ? ' (' . $row->variant . ')' : '').'</td>'
                                        . '<td class="text-left border-right" style="width:20%;border-right: 2px solid #DDDDDD !important;">'.$row->product_name.'</td>'
                                        . '<td class="text-left border-right" style="width:20%;border-right: 2px solid #DDDDDD !important;">'.$row->hsn_code.'</td>'
                                         .'<td class="text-left border-right" style="border-right: 2px solid #DDDDDD !important;">'.$this->sma->formatMoney($row->real_unit_price).'</td>';
                                         if($row->sale_status!='foc'){
                                            echo '<td class="text-left border-right" style="border-right: 2px solid #DDDDDD !important;">' .$this->sma->formatMoney($disc). '</td>';
                                        }
                                        echo '<td class="text-left border-right" style="border-right: 2px solid #DDDDDD !important;">' .round($row->quantity). '</td>'
                                         .'<td class="text-left border-right" style="">'.($row->sale_status!='foc'?$this->sma->formatMoney($row->net_unit_cost):0).'</td>'
                                         . '<td class="text-left border-right tax_tb" style="padding:0px !important;">
                ...
                //                        . '<td class="text-left">' . $prod_amount . '</td>'
                                        .'<td class="" style="text-align:left;border-right: 2px solid #DDDDDD !important;">'.$this->sma->formatMoney($row->real_unit_price-$row->item_discount).'</td>'
                                        . '</tr>';
                                    }
                            ...
                            <tfoot>
                                <tr style="border:2px solid #DDDDDD">
                                    <th colspan="<?php echo $rows[0]->sale_status=='foc'?4:5?>" class="text-left"></th>
                                    <th colspan="" class="text-left"><?= lang("total"); ?>&nbsp;<!-- <span class="rupee">&#8377;</span> --></th>
                                    <th><?php echo intval($total_items)?></th>
                                    <th class='text-left '><?=$this->sma->formatMoney($total_basic_price)?></th>
                                    ...
                                    <th class='text-left border-right'><?php echo $this->sma->formatMoney($total_mrp)?></th>
                            ...
                            <?php } else { ?>
                               <!--  <tr>
                                ...
                                <tr><td colspan="5" class="border-right" style="">
                            ...
                            ?>
                                ...
                                <td colspan="6">
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td width="60%" style="text-align:right"><span><?= lang("taxable_amount"); ?></span></td><td align="right"><?=$this->sma->formatMoney($inv->sale_status!='foc'?$total_basic_price:0)?></td>
                                        </tr>
                                        ...
                                        ?>
                                        <tr>
                                            <td width="60%" style="text-align:right"><?= lang("total_amount"); ?></td><td align="right"><?php echo $this->sma->formatMoney($total_mrp)?></td>
                                        </tr>
                                    </table>
                        ...
                        <?php  if($inv->grand_total > 0){ ?>
                            <tr style="border-bottom:2px solid #DDDDDD;border-top:2px solid #DDDDDD">
...
<!--                        <th class="text-left" colspan="6"><?=$this->sma->formatMoney($inv->grand_total + $rounding)?></th>-->
                            ...
                            if ($inv->paid < $inv->grand_total) { ?>
                                <tr>
                                    <th colspan="10"><?= lang("paid_amount"); ?></th>                    
                                    <th class="text-left" ><?= $this->sma->formatMoney($inv->paid); ?></th>
                                </tr>
                                <tr>
                                    <th colspan="10"><?= lang("due_amount"); ?></th>
                            ...
                            <tr>
                                <td colspan="11" style="">
                                     <table style="width:100%">
                                        <thead>
                                            <tr>
                                                <th style="font-weight:normal !important; font-size:9px !important;">
                                                      <h5 class="text-left" style="font-size: 9px">Declaration: </h5>
                                                      <p class="declaration text-justify" style="font-size: 9px">1. We declare that this invoice shows the actual price of the goods described and that all particulars are true and correct.</p>
                                                    ...
                                                    ?>
                                                      <p class="declaration text-justify" style="font-size: 9px">3. Unless otherwise stated, tax on this invoice is not payable under reverse charge.</p>
                                                    <?php                                                    
                                                    }
                                                    ?>
