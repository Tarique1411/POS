        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="RESLData" class="table table-bordered table-hover table-striped" style="width:100%;">
                        <thead>
                        <tr>
                            <th></th>
<!--                            <th style="min-width:30px; width: 30px; text-align: center;">
                            ...
                            <th><?php echo $this->lang->line("pay_status"); ?></th>
                            <th><?php echo $this->lang->line("customer"); ?></th>
                <th><?php echo $this->lang->line("mobile_no"); ?></th>
                           
                            <th><?php echo $this->lang->line("grand_total"); ?>&nbsp;<span class="rupee">&#8377;</span></th>
<!--                            <th style="min-width:30px; width: 30px; text-align: center;">
                                <input class="checkbox checkft" type="checkbox" name="check"/>
                            </th>
