        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <?php echo form_input('card_no', '', 'class="form-control" id="card_no" required="required" readonly="readonly"'); ?>
                    <div class="input-group-addon" style="padding-left: 10px; padding-right: 10px;">
                        <a href="#" id="genNo"><i class="fa fa-cogs"></i></a></div>
                </div>
            </div>
            <div class="form-group">
                <?= lang("value", "value"); ?>
                <?php 
					$attr = array('name'=>'value','type'=>'text','class'=>'form-control','id'=>'value','min'=>1,'step'=>1);
					echo form_input($attr); 
				?>
            </div>
            <div class="form-group">
                <input type="checkbox" class="checkbox" name="staff_points" id="staff_points"><label for="staff_points"
                                                                                                     class="padding05"><?= lang('use_staff_award_points'); ?></label>
            </div>
            ...
            <div class="form-group">
                ...
                <?php 
					...
					echo form_input('expiry', $expiry_time, 'class="form-control" id="expiry" readonly="readonly"'); 
				?>
            </div>
