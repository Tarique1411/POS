...
//echo "Pcode....=>".$product->code."<br>Barcode Symbology....=>".$product->barcode_symbology;
?>
    <!--br>Barcode ....=><?=$product->barcode;?><br><br-->&nbsp;&nbsp;&nbsp;&nbsp;<img src="<?= base_url() ?>/assets/uploads/barcode/<?= $product->code ?>.png"
                                     alt="<?= $product->name ?>"/>
    <div class="col-lg-12">
        ...
        <div class="clearfix"></div>
         <?php $product->barcode_symbology = 128;?>
        ...
        <!--img src="<?= base_url() ?>assets/uploads/barcode<?= $this->session->userdata('user_id') ?>.png"
             alt="<?= $product->barc ?>" style="float:right;"/-->
            ...
            <div class="col-sm-7">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped dfTable table-right-left">
                        ...
                        <tr>
                            <td><?php echo $this->lang->line("product_symbology"); ?></td>
                            <td><?php echo $product->barcode_symbology; ?></td>
                        </tr>
                        <tr>
...
//                                        if ($warehouse->quantity != 0) {
                                            echo '<tr><td>' . $warehouse->name . ' (' . $warehouse->code . ')</td><td><strong>' . $this->sma->formatQuantity($warehouse->quantity) . '</strong>' . ($warehouse->rack ? ' (' . $warehouse->rack . ')' : '') . '</td>';
                                            echo '<td>'.$this->sma->formatMoney($product->cost).'</td><td>'.$this->sma->formatMoney($product->price).'</td><td>'.$this->sma->formatMoney($product->lot_no).'</td></tr>';
//                                        }
                                    } ?>
                                    </tbody>
                                </table>
