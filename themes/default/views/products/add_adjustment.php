        ...
        <div class="modal-body">
            ...
            <?php if ($Owner || $Admin) { ?>
                <div class="form-group">
                    ...
                    <div class="controls">
                        <?php echo form_input('date', '', 'class="form-control datetime" id="date" readonly = "readonly" required="required"'); ?>
                    </div>
                </div>
            <?php } ?>
            ...
            <div class="form-group">
                ...
                <div class="controls"> <?php echo form_input('quantity', (isset($_POST['quantity']) ? $_POST['quantity'] : ""), 'class="form-control input-tip" type="number" id="quantity" required="required"'); ?> </div>
            </div>
