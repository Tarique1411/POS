        ...
        <div class="modal-body">
            ...
            <?php if ($Owner || $Admin) { ?>
                <div class="form-group">
                    ...
                    <div class="controls">
                        <?php echo form_input('date', date($dateFormats['php_ldate'], strtotime($damage->date)), 'class="form-control datetime" id="date" required="required" readonly = "readonly"'); ?>
                    </div>
                </div>
            <?php } ?>
            ...
            <div class="form-group">
                ...
                <div class="controls1"> <?php echo form_input('quantity',  (isset($_POST['quantity']) ? $_POST['quantity'] : $damage->quantity), 'onkeypress="return isNumberKey(event)" type="number" class="form-control input-tip" id="quantity" required="required"'); ?> </div>
            </div>
