                            ...
                            <div class="col-sm-7">
                                <div class="table-responsive">
                                    <table class="table table-borderless table-striped dfTable table-right-left">
                                        ...
                                        <tr>
                                            <td style="width:30%;"><?= lang("barcode_pcode"); ?></td>
                                            <td style="width:70%;"><?php echo $product->code ?><?php //echo $product->barcode ?>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="<?= base_url() ?>/assets/uploads/barcode/<?= $product->code ?>.png"
                                     alt="<?= $product->name ?>"/>
                                        ...
                                        <!-- <?php if ($product->tax_rate) { ?>
                                            <tr>
                                                <td><?= lang("tax_rate"); ?>&nbsp;<span class="rupee">&#8377;</span></td>
...
//                                                        if ($warehouse->quantity != 0) {
                                                            echo '<tr><td>' . $warehouse->name . ' (' . $warehouse->code . ')</td><td>' . $this->sma->formatQuantity($warehouse->quantity)  . ($warehouse->rack ? ' (' . $warehouse->rack . ')' : '') . '</td>';
