                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php if($GP['products-edit'] == 1) { echo $p->{'products-edit'} ? "&#10004;" : '';} ?> 
                                    </td>
                                    <td class="text-center">
                                         <?php if($GP['products-delete'] == 1) { echo $p->{'products-delete'} ? "&#10004;" : '';} ?> 
                                    </td>
                                    <td>
                                        <?php  
                                         if($GP['products-print_barcodes'] == 1) { echo ($p->{'products-print_barcodes'} == 1) ? "&#10004;" : ''; ?><label class="padding05"><?= lang('print_barcodes') ?></label>
                                        <?php } 
                                        if($GP['products-print_labels'] == 1) { echo ($p->{'products-print_labels'} == 1) ? "&#10004;" : ''; ?><label
                                             class="padding05"><?= lang('print_labels') ?></label>  
                                        <?php } 
                                          if($GP['products-sync_quantity'] == 1) {    
                                           echo $p->{'products-sync_quantity'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('sync_quantity') ?></label> 
                                        <?php } 
                                          if($GP['products-export_excel'] == 1) { echo $p->{'products-export_excel'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('excel') ?></label><?php } 
                                          if($GP['products-export_pdf'] == 1) { echo $p->{'products-export_pdf'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('pdf') ?></label><br>   <?php } 
                                          if($GP['products-details'] == 1) { echo $p->{'products-details'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('products_details') ?></label><?php } 
                                          if($GP['products-duplicate'] == 1) { echo $p->{'products-duplicate'} ? "&#10004;" : ''; ?><labelclass="padding05"><?= lang('duplicate_product') ?></label><?php } 
                                          if($GP['products-image'] == 1) { echo $p->{'products-image'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('view_image') ?></label><?php } 
                                          if($GP['products-adjust_quantity'] == 1) { echo $p->{'products-adjust_quantity'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('adjust_quantity') ?></label> <?php } ?>     
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td><?= lang("sales"); ?></td>
                                    <td class="text-center">
                                        <?php if($GP['sales-index'] == 1) { echo $p->{'sales-index'} ? "&#10004;" : ''; } ?>
                                    </td>
                                    <td class="text-center">
                                        <?php if($GP['sales-add'] == 1) { echo $p->{'sales-add'} ? "&#10004;" : ''; } ?>
                                    </td>
                                    <td class="text-center">
                                        <?php if($GP['sales-edit'] == 1) { echo $p->{'sales-edit'} ? "&#10004;" : '';} ?>
                                    </td>
                                    <td class="text-center">
                                        <?php if($GP['sales-delete'] == 1) { echo $p->{'sales-delete'} ? "&#10004;" : ''; } ?>
                                    </td>
                                    <td> 
                                        <?php if($GP['sales-email'] == 1) { echo $p->{'sales-email'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('email') ?></label> <?php } ?>
                                        <?php if($GP['sales-pdf'] == 1) { echo $p->{'sales-pdf'} ? "&#10004;" : ''; ?><label for="sales-pdf" class="padding05"><?= lang('pdf') ?></label> <?php }                                       
                                        if($GP['sales-payments'] == 1) { echo $p->{'sales-payments'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('payments') ?></label> <?php } 
                                        if($GP['sales-view_payments'] == 1) { echo $p->{'sales-view_payments'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('view_payments') ?></label><?php } 
                                        if($GP['sales-sales_details'] == 1) { echo $p->{'sales-sales_details'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('sales_details') ?></label> <?php } ?>    
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php if($GP['pos-sales_add'] == 1) { echo $p->{'pos-sales_add'} ? "&#10004;" : '';  } ?>
                                    </td>
                                    <td class="text-center">
                                        
                                    </td>
                                    <td class="text-center">
                                        <?php if($GP['pos-sales_delete'] == 1) { echo $p->{'pos-sales_delete'} ? "&#10004;" : '';  } ?>
                                    </td>
                                    <td> 
                                        <?php if($GP['pos-sales_email'] == 1) { echo $p->{'pos-sales_email'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('email') ?></label><?php } 
                                        if($GP['pos-sales_pdf'] == 1) { echo $p->{'pos-sales_pdf'} ? "checked" : ''; ?><label class="padding05"><?= lang('pdf') ?></label> <?php } 
                                        if($GP['pos-sales_excel'] == 1) { echo $p->{'pos-sales_excel'} ? "checked" : ''; ?><label class="padding05"><?= lang('excel') ?></label><?php } 
                                        if($GP['pos-sales_payments'] == 1) { echo $p->{'pos-sales_payments'} ? "checked" : ''; ?><label class="padding05"><?= lang('payments') ?></label><?php } 
                                        if($GP['pos-view_payments'] == 1) { echo $p->{'pos-view_payments'} ? "checked" : ''; ?><label class="padding05"><?= lang('view_payments') ?></label><?php } 
                                        if($GP['pos-view_reciept'] == 1) { echo $p->{'pos-view_reciept'} ? "checked" : ''; ?><label class="padding05"><?= lang('view_reciept') ?></label><?php } ?>    
                                    </td>
                                </tr>
...
<!--                                <tr>
                                ...
                                <tr>
                                    <td><?= lang("credit_voucher"); ?></td>
                                    <td class="text-center">
                                        <?php if($GP['sales-gift_cards'] == 1) { echo $p->{'sales-gift_cards'} ? "&#10004;" : '';} ?>
                                    </td>
                                    <td class="text-center">
                                        <?php if($GP['sales-add_gift_card'] == 1) { echo $p->{'sales-add_gift_card'} ? "&#10004;" : '';} ?>
                                    </td>
                                    <td class="text-center">
                                        <?php if($GP['sales-edit_gift_card'] == 1) { 
                                       echo $p->{'sales-edit_gift_card'} ? "&#10004;" : '';} ?>
                                    </td>
                                    <td class="text-center">
                                        <?php if($GP['sales-delete_gift_card'] == 1) { echo $p->{'sales-delete_gift_card'} ? "&#10004;" : '';} ?>
                                    </td>
                                    <td>
                                        <?php if($GP['sales-gift_pdf'] == 1) { echo $p->{'sales-gift_pdf'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('pdf') ?></label><?php } 
                                        if($GP['sales-gift_excel'] == 1) { echo $p->{'sales-gift_excel'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('excel') ?></label><?php } 
                                        if($GP['sales-credit_voucher_setting'] == 1) { echo $p->{'sales-credit_voucher_setting'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('credit_voucher_setting') ?></label><?php }
                                        if($GP['sales-credit_voucher_pdf'] == 1) { echo $p->{'sales-credit_voucher_pdf'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('credit_voucher_pdf') ?></label><?php } 
                                        if($GP['sales-credit_voucher_excel'] == 1) { echo $p->{'sales-credit_voucher_excel'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('credit_voucher_excel') ?></label><?php } 
                                        if($GP['sales-credit_voucher_add'] == 1) { echo $p->{'sales-credit_voucher_add'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('credit_voucher_add') ?></label><?php } 
                                        if($GP['sales-credit_voucher_edit'] == 1) { echo $p->{'sales-credit_voucher_edit'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('credit_voucher_edit') ?></label><?php } 
                                        if($GP['sales-credit_voucher_delete'] == 1) { echo $p->{'sales-credit_voucher_delete'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('credit_voucher_delete') ?></label><?php } ?>  
                                    </td>
                                </tr>
...
<!--                                <tr>
                                ...
                                <tr>
                                    <td><?= lang("customers"); ?></td>
                                    <td class="text-center">
                                        <?php if($p->{'customers-index'} == 1) { echo $p->{'customers-index'} ? "&#10004;" : '';} ?>
                                    </td>
                                    <td class="text-center">
                                        <?php if($p->{'customers-add'} == 1) { echo $p->{'customers-add'} ? "&#10004;" : '';} ?>
                                    </td>
                                    <td class="text-center">
                                        <?php if($p->{'customers-edit'} == 1) { echo $p->{'customers-edit'} ? "&#10004;" : '';} ?>
                                    </td>
                                    <td class="text-center">
                                        <?php if($p->{'customers-delete'} == 1) {$p->{'customers-delete'} ? "&#10004;" : ''; } ?>
                                    </td>
                                    <td>
                                        <?php if($GP['customers-pdf'] == 1) { echo $p->{'customers-pdf'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('pdf') ?></label><?php } 
                                        if($GP['customers-excel'] == 1) { echo $p->{'customers-excel'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('excel') ?></label> <?php } 
                                        if($GP['customers-add_by_csv'] == 1) { echo $p->{'customers-add_by_csv'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('customers-add_by_csv') ?></label><?php } 
                                        if($GP['users-delete_users'] == 1) { echo $p->{'users-delete_users'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('delete_users') ?></label><?php } 
                                        if($GP['users-pdf'] == 1) { echo $p->{'users-pdf'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('users_pdf') ?></label><?php } 
                                        if($GP['users-excel'] == 1) { echo $p->{'users-excel'} ? "checked" : ''; ?><label class="padding05"><?= lang('users_excel') ?></label><?php } ?>    
                                    </td>
                                </tr>
...
<!--                                <tr>
                        ...
                        <div class="table-responsive">
                            <table cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tr>
                                    <td>
                                        <?php 
                                        if($GP['pos-pos_tip']) { echo $p->{'pos-pos_tip'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('pos') ?></label> <?php }
                                        if($GP['pos-tip_calc']) { echo $p->{'pos-tip_calc'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('pos-tip_calc') ?></label>
                                        <?php } 
                                        if($GP['pos-tip_holdsale']) { echo $p->{'pos-tip_holdsale'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('pos-tip_holdsale') ?></label><?php } 
                                        if($GP['pos-tip_registerdetails']) { echo $p->{'pos-tip_registerdetails'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('pos-tip_registerdetails') ?></label><?php } 
                                        if($GP['pos-tip_closeregister']) { echo $p->{'pos-tip_closeregister'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('pos-tip_closeregister') ?></label><?php } 
                                        if($GP['pos-tip_addexpense']) { echo $p->{'pos-tip_addexpense'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('pos-tip_addexpense') ?></label><?php } 
                                        if($GP['pos-tip_todayprofit']) { echo $p->{'pos-tip_todayprofit'} ? "&#10004;" : ''; ?>><label class="padding05"><?= lang('pos-tip_todayprofit') ?></label><?php } 
                                        if($GP['pos-tip_todaysale']) { echo $p->{'pos-tip_todaysale'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('pos-tip_todaysale') ?></label><?php } 
                                        if($GP['pos-tip_openregister']) { echo $p->{'pos-tip_openregister'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('pos-tip_openregister') ?></label><?php } 
                                        if($GP['pos-tip_cleardata']) { echo $p->{'pos-tip_cleardata'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('pos-tip_cleardata') ?></label><?php } 
                                        if($GP['pos-tip_accessories']) { echo $p->{'pos-tip_accessories'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('pos-tip_accessories') ?></label> <?php } ?>    
                                    </td>
                         ...
                         <div class="table-responsive">
                            <table cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tr>
                                    <td>
                                        <?php if($GP['till-index'] == 1) { echo $p->{'till-index'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('till_view') ?></label><?php } 
                                        if($GP['till-addTill'] == 1) { echo $p->{'till-addTill'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('add_till') ?></label><?php } 
                                        if($GP['till-manageTill'] == 1) { echo $p->{'till-manageTill'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('manage_till') ?></label> <?php }
                                        if($GP['till-deleteTill'] == 1) { echo $p->{'till-deleteTill'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('delete') ?></label><?php } ?>    
                                    </td>
                                </tr>
                                </thead>
                            </table>
                        ...
                        <div class="table-responsive">
                            <table cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tr>
                                    <td>
                                        <?php if($GP['products-list'] == 1) { echo $p->{'products-list'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('list_products') ?></label><?php }
                                        if($GP['print_barcodes'] == 1) { echo $p->{'print_barcodes'} ? "&#10004;" : ''; ?>><label class="padding05"><?= lang('print_barcodes') ?></label><?php } 
                                        if($GP['print_labels'] == 1) { echo $p->{'print_labels'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('print_labels') ?></label><?php }
                                        if($GP['import_product'] == 1) { echo $p->{'import_product'} ? "&#10004;" : ''; ?><label for="import_product" class="padding05"><?= lang('import_product') ?></label><?php } 
                                        if($GP['update_price'] == 1) { echo $p->{'update_price'} ? "&#10004;" : ''; ?><label for="update_price" class="padding05"><?= lang('update_price') ?></label> <?php } 
                                        if($GP['products-quantity_adjustments'] == 1) { echo $p->{'products-quantity_adjustments'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('quantity_adjustments') ?></label> <?php } 
                                        if($GP['products-quantity_excel']) { echo $p->{'products-quantity_excel'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('products-quantity_excel') ?></label><?php } 
                                        if($GP['products-quantity_pdf']) { echo $p->{'products-quantity_pdf'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('products-quantity_pdf') ?></label> <?php } 
                                        if($GP['products-quantity_delete']) { echo $p->{'products-quantity_delete'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('products-quantity_delete') ?></label><?php } ?>                                                                              
                                    </td>
                                </tr>
                                </thead>
                            </table>
                        ...
                        <div class="table-responsive">
                            <table cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tr>
                                    <td>
                                        <?php if($GP['sales-list'] == 1) { echo $p->{'sales-list'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('list_sales') ?></label><?php }
                                        if($GP['add_sale_by_csv'] == 1) { echo $p->{'add_sale_by_csv'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('add_sale_by_csv') ?></label><?php } 
                                        if($GP['credit_voucher'] == 1) { echo $p->{'credit_voucher'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('credit_voucher') ?></label><?php }
                                        if($GP['sales-return_sales'] == 1) { echo $p->{'sales-return_sales'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('return_sales') ?></label> <?php } ?>                                         
                                    </td>
                                </tr>
                                </thead>
                            </table>
...
<!--                        <div class="table-responsive">
                        ...
                        <div class="table-responsive">
                            <table cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tr>
                                    <td>
                                        <?php  if($GP['users_list'] == 1) { echo $p->{'users_list'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('list_users') ?></label><?php }
                                        if($GP['users-add'] == 1) { echo $p->{'users-add'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('add_user') ?></label><?php }
                                        if($GP['billers-list'] == 1) { echo $p->{'billers-list'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('list_billers') ?></label><?php } 
                                        if($GP['billers-add'] == 1) { echo $p->{'billers-add'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('add_biller') ?></label><?php } 
                                        if($GP['notifications']) { echo $p->{'notifications'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('notifications') ?></label><?php } ?>    
                                    </td>
                                </tr>
                                </thead>
                            </table>
                        ...
                        <div class="table-responsive">
                            <table cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tr>
                                    <td>
                                        <?php  if($GP['settings-index']) { echo $p->{'settings-index'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('settings') ?></label><?php } 
                                        if($GP['system_settings']) { echo $p->{'system_settings'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('system_settings') ?></label><?php } 
                                        if($GP['pos_settings']) { echo $p->{'pos_settings'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('pos_settings') ?></label><?php }     
                                        if($GP['change_logo']) { echo $p->{'change_logo'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('change_logo') ?></label> <?php } 
                                        if($GP['currencies']) { echo $p->{'currencies'} ? "&#10004;" : ''; ?><label class="padding05"><?= lang('currencies') ?></label><?php } 
                                        if($GP['customer_groups']) { echo $p->{'customer_groups'} ? "&#10004;" : ''; ?><label
                                            class="padding05"><?= lang('customer_groups') ?></label><?php }   
                                         if($GP['categories']) { echo $p->{'categories'} ? "&#10004;" : ''; ?><label
                                            for="categories" class="padding05"><?= lang('categories') ?></label><br><?php }  
                                        if($GP['variants']) { echo $p->{'variants'} ? "&#10004;" : ''; ?><label
                                               for="variants" class="padding05"><?= lang('variants') ?></label>
                                        <?php } 
                                           
                                        if($GP['tax_rates']) { echo $p->{'tax_rates'} ? "&#10004;" : ''; ?><label
                                            for="tax_rates" class="padding05"><?= lang('tax_rates') ?></label>
                                        <?php echo $p->{'warehouses'} ? "checked" : ''; ?><label
                                            for="warehouses" class="padding05"><?= lang('warehouses') ?></label>
                                        <?php } 
                                        if($GP['email_templates']) { echo $p->{'email_templates'} ? "&#10004;" : ''; ?><label
                                            for="email_templates" class="padding05"><?= lang('email_templates') ?></label>
                                        <?php } 
                                        if($GP['group_permissions']) { echo $p->{'group_permissions'} ? "&#10004;" : ''; ?><label
                                            for="group_permissions" class="padding05"><?= lang('group_permissions') ?></label>
                                        <?php } 
                                        if($GP['backups']) { echo $p->{'backups'} ? "&#10004;" : ''; ?>><label
                                            for="backups" class="padding05"><?= lang('backups') ?></label>
                                        <?php } 
                                        if($GP['update_version']) { echo $p->{'update_version'} ? "&#10004;" : ''; ?><label
                                            for="update_version" class="padding05"><?= lang('update_version') ?></label> 
                                        <?php } ?>     
                                    </td>
                                </tr>
                        ...
                        <div class="table-responsive">
                            <table cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tr>
                                    <td>
                                        <?php if($GP['reports-index']==1) { echo $p->{'reports-index'} ? "&#10004;" : ''; ?><label
                                            for="reports-index"
                                            class="padding05"><?= lang('reports') ?></label>
                                        <?php } 
                                        if($GP['overview_chart']==1) { echo $p->{'overview_chart'} ? "&#10004;" : ''; ?><label
                                            for="overview_chart"
                                            class="padding05"><?= lang('overview_chart') ?></label>
                                        <?php }
                                        if($GP['reports-warehouse_stock']==1) { echo $p->{'reports-warehouse_stock'} ? "&#10004;" : ''; ?><label
                                            for="reports-warehouse_stock"
                                            class="padding05"><?= lang('warehouse_stock_chart') ?></label>
                                        <?php }
                                        if($GP['register_report']==1) { echo $p->{'register_report'} ? "&#10004;" : ''; ?><label
                                            for="register_report" class="padding05"><?= lang('register_report') ?></label>
                                        <?php }
                                        if($GP['reports-quantity_alerts']==1) { echo $p->{'reports-quantity_alerts'} ? "&#10004;" : ''; ?><label
                                            for="product_quantity_alerts"
                                            class="padding05"><?= lang('product_quantity_alerts') ?></label><br>
                                        <?php }
                                        if($GP['reports-expiry_alerts']==1) { echo $p->{'reports-expiry_alerts'} ? "&#10004;" : ''; ?><label
                                            for="Product_expiry_alerts"
                                            class="padding05"><?= lang('product_expiry_alerts') ?></label>
                                        <?php }
                                        if($GP['reports-products']==1) { echo $p->{'reports-products'} ? "&#10004;" : ''; ?><label
                                            for="products" class="padding05"><?= lang('products') ?></label>
                                        <?php }
                                        if($GP['categories_report']==1) { echo $p->{'categories_report'} ? "&#10004;" : ''; ?><label
                                            for="categories_report" class="padding05"><?= lang('categories_report') ?></label>
                                        <?php }
                                        if($GP['reports-daily_sales']==1) { echo $p->{'reports-daily_sales'} ? "&#10004;" : ''; ?><label
                                            for="daily_sales" class="padding05"><?= lang('daily_sales') ?></label>
                                        <?php }
                                        if($GP['reports-monthly_sales']==1) { echo $p->{'reports-monthly_sales'} ? "&#10004;" : ''; ?><label
                                            for="monthly_sales" class="padding05"><?= lang('monthly_sales') ?></label>
                                        <?php }
                                        if($GP['reports-sales']==1) { echo $p->{'reports-sales'} ? "&#10004;" : ''; ?><label
                                            for="reports-sales" class="padding05"><?= lang('sales_report') ?></label>
                                        <?php }
                                        if($GP['reports-payments']==1) { echo $p->{'reports-payments'} ? "&#10004;" : ''; ?><label
                                            for="payments" class="padding05"><?= lang('payments') ?></label>
                                        <?php }
                                        if($GP['reports-profit_loss']==1) { echo $p->{'reports-profit_loss'} ? "&#10004;" : ''; ?><label
                                            for="reports-profit_loss" class="padding05"><?= lang('profit_loss') ?></label>   
                                        <?php }
                                        if($GP['reports-purchases']==1) { echo $p->{'reports-purchases'} ? "&#10004;" : ''; ?><label
                                            for="purchases" class="padding05"><?= lang('purchases') ?></label>
                                        <?php }
                                        if($GP['reports-customers']==1) { echo $p->{'reports-customers'} ? "&#10004;" : ''; ?><label
                                            for="customers" class="padding05"><?= lang('customers') ?></label>
                                        <?php }
                                        if($GP['reports-suppliers']==1) { echo $p->{'reports-suppliers'} ? "&#10004;" : ''; ?><label
                                            for="suppliers" class="padding05"><?= lang('suppliers') ?></label>
                                        <?php }
                                        if($GP['staff_report']==1) { echo $p->{'staff_report'} ? "&#10004;" : ''; ?>><label
