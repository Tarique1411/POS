        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <!--Update by Chitra to allow only admin and owner to change default billers -->
                    <?php if($Owner || $Admin) { ?>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="control-label"
                    ...
                    <?php } ?>        
                     <!--  Add By Ankit for dashboard configure -->   
                     <div class="col-md-4">
                       <div class="form-group">
                           <?= lang('products_menu_tab', 'products_menu_tab'); ?>
                           <div class="controls">  <?php
                               echo form_dropdown('products', $ps, $Settings->products_menu_tab, 'class="tip form-control" required="required" id="products_menu_tab" style="width:100%;"');
                               ?> </div>
                       </div>
                   </div>
                   <div class="col-md-4">
                       <div class="form-group">
                           <?= lang('quotations_menu_tab', 'quotations_menu_tab'); ?>
                           <div class="controls">  <?php
                               echo form_dropdown('quotations', $ps, $Settings->quotations_menu_tab, 'class="tip form-control" required="required" id="quotations_menu_tab" style="width:100%;"');
                               ?> </div>
                       </div>
                   </div>
                   <div class="col-md-4">
                       <div class="form-group">
                           <?= lang('sales_menu_tab', 'sales_menu_tab'); ?>
                           <div class="controls">  <?php
                               echo form_dropdown('sales', $ps, $Settings->sales_menu_tab, 'class="tip form-control" required="required" id="sales_menu_tab" style="width:100%;"');
                               ?> </div>
                       </div>
                   </div>
                   <div class="col-md-4">
                       <div class="form-group">
                           <?= lang('people_menu_tab', 'people_menu_tab'); ?>
                           <div class="controls">  <?php
                               echo form_dropdown('people', $ps, $Settings->people_menu_tab, 'class="tip form-control" required="required" id="people_menu_tab" style="width:100%;"');
                               ?> </div>
                       </div>
                   </div>
                   <div class="col-md-4">
                       <div class="form-group">
                           <?= lang('purchases_menu_tab', 'purchases_menu_tab'); ?>
                           <div class="controls">  <?php
                               echo form_dropdown('purchases', $ps, $Settings->purchases_menu_tab, 'class="tip form-control" required="required" id="purchases_menu_tab" style="width:100%;"');
                               ?> </div>
                       </div>
                   </div>  
                   <div class="col-md-4">
                       <div class="form-group">
                           <?= lang('transfers_menu_tab', 'transfers_menu_tab'); ?>
                           <div class="controls">  <?php
                               echo form_dropdown('transfers', $ps, $Settings->transfers_menu_tab, 'class="tip form-control" required="required" id="transfers_menu_tab" style="width:100%;"');
                               ?> </div>
                       </div>
                   </div>
                   <div class="col-md-4">
                       <div class="form-group">
                           <?= lang('notifications_menu_tab', 'notifications_menu_tab'); ?>
                           <div class="controls">  <?php
                               echo form_dropdown('notifications', $ps, $Settings->notifications_menu_tab, 'class="tip form-control" required="required" id="notifications_menu_tab" style="width:100%;"');
                               ?> </div>
                       </div>
                   </div>
                   <div class="col-md-4">
                       <div class="form-group">
                           ...
                           <?= lang('reports_menu_tab', 'reports_menu_tab'); ?>
                           <div class="controls">  <?php
                               echo form_dropdown('reports', $ps, $Settings->reports_menu_tab, 'class="tip form-control" required="required" id="reports_menu_tab" style="width:100%;"');
                               ?> </div>
                       </div>
                   </div>
                    
                   <!--End Code Add By Ankit for dashboard Menu Tab configure-->         
