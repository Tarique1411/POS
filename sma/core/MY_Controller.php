...
class MY_Controller extends CI_Controller {
    ...
    function __construct()
    {
        ...
        if($this->loggedIn) {
            ...
            $this->session->set_userdata('default_biller',$biller);
            ...
            $this->data['Owner'] = $this->Owner;
             $this->Manager = $this->sma->in_group('manager') ? TRUE : NULL; //added for manager
            $this->data['Manager'] = $this->Manager;
            $this->Customer = $this->sma->in_group('customer') ? TRUE : NULL;
            $this->data['Customer'] = $this->Customer;
            $this->Sales = $this->sma->in_group('sales') ? TRUE : NULL;//added for sales person
            ...
            //Remove $this->Admin By Anil 20-09-2016
            if(!$this->Owner) {  
    ...
    function page_construct($page, $meta = array(), $data = array()) {
        ...
        $meta['Manager'] = $data['Manager'];//added for manager
        $meta['Sales'] = $data['Sales'];//added for sales person
