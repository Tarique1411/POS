...
class system_settings extends MY_Controller {
    ...
    function __construct() {
        ...
        //*** admin added by anil 20-09-2016***
    ...
    function index() {
       //***** Added By Anil 20-09-2016 start****        
            $arr_settings = $this->site->checkPermissions(); 
            if($arr_settings[0]['system_settings'] == NULL && ! $this->Owner){
                $this->session->set_flashdata('error', lang("access_denied"));
                redirect('welcome'); 
            }
        //***** Added By Anil 20-09-2016 End****   
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array('site_name' => DEMO ? 'Stock Manager Advance' : $this->input->post('site_name'),
                ...
                'products_menu_tab' => $this->input->post('products'),
                'quotations_menu_tab' => $this->input->post('quotations'),
                'sales_menu_tab' => $this->input->post('sales'),
                'people_menu_tab' => $this->input->post('people'),
                'purchases_menu_tab' => $this->input->post('purchases'),
                'transfers_menu_tab' => $this->input->post('transfers'),
                'notifications_menu_tab' => $this->input->post('notifications'),
                'reports_menu_tab' => $this->input->post('reports'),
            );
    ...
    function change_logo() {
        ...
        //***** Added By Anil 20-09-2016 start****        
            $arr_changelogo = $this->site->checkPermissions();             
            if($arr_changelogo[0]['change_logo'] == NULL && ! $this->Owner){
                $this->session->set_flashdata('error', lang("access_denied"));
                redirect('welcome'); 
            }
        //*****  Added By Anil 20-09-2016  End**** 
    ...
    function updates() {
        ...
        //***** Added By Anil 20-09-2016 start****        
            $arr_updates = $this->site->checkPermissions(); 
            if($arr_updates[0]['update_version'] == NULL && ! $this->Owner){
                $this->session->set_flashdata('error', lang("access_denied"));
                redirect('welcome'); 
            }
        //***** Added By Anil 20-09-2016 End**** 
        ...
        if (!$this->Owner && !$this->Admin && !$this->Manager) {  // *** Added By Anil 20/09/2016 ***
            $this->session->set_flashdata('error', lang('access_denied'));
            redirect("welcome");
        }
    ...
    function backups() {
        //***** Added By Anil 20-09-2016 start****        
            $arr_backups = $this->site->checkPermissions(); 
            if($arr_backups[0]['backups'] == NULL && ! $this->Owner){
                $this->session->set_flashdata('error', lang("access_denied"));
                redirect('welcome'); 
            }
        //***** Added By Anil 20-09-2016 End**** 
    ...
    function email_templates($template = "credentials") {
         //***** Added By Anil 20-09-2016 start****        
            $arr_email_temp = $this->site->checkPermissions(); 
            if($arr_email_temp[0]['email_templates'] == NULL && $this->Owner){
                $this->session->set_flashdata('error', lang("access_denied"));
                redirect('welcome'); 
            }
        //***** Added By Anil 20-09-2016 End**** 
    ...
    function create_group() {
        ...
        if ($this->input->post('group_name')) {
            ...
            // Add by Ankit for copy Group permissions at time of new group create
            $copy= array('copyGP' => $this->input->post('copyGP'));
            $new_group_id = $this->settings_model->addGroup($data, $copy);
            ...
            $this->data['modal_js'] = $this->site->modal_js();
            $this->data['groupInfo'] = $this->settings_model->getGroup(); // Add By Ankit
    ...
    function permissions($id = NULL) {
        ...
        /* Added By Anil 17-09-2016 Start */
        
        if(($this->uri->segment(3)) == $this->session->userdata('group_id')) {
            $this->session->set_flashdata('error', lang("access_denied"));
                redirect('welcome');            
        }
        if($this->Manager && $this->uri->segment(3) == 2) {
              $this->session->set_flashdata('error', lang("access_denied"));
              redirect('welcome');  
           }
        
        /* Added By Anil 17-09-2016 End */
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array(
                ...
                'products-add' => $this->input->post('products-add')?$this->input->post('products-add'):NULL,
               ...
               // 'products-price' => $this->input->post('products-price'),
                ...
                'sales-edit' => $this->input->post('sales-edit')?$this->input->post('sales-edit'):NULL,
                'sales-add' => $this->input->post('sales-add')?$this->input->post('sales-add'):NULL,
                ...
                'sales-add_gift_card' => $this->input->post('sales-add_gift_card')?$this->input->post('sales-add_gift_card'):NULL,
                ...
                /* Permissions fields Added By Anil Starts */    
                
                'till-index' => $this->input->post('till-index'),
                'till-addTill' => $this->input->post('till-addTill'),
                'till-manageTill' => $this->input->post('till-manageTill'),
                'till-deleteTill' => $this->input->post('till-deleteTill'),
                'products-list' => $this->input->post('products-list'),                
                'print_barcodes' => $this->input->post('print_barcodes'),
                'print_labels' => $this->input->post('print_labels'),
                'import_product' => $this->input->post('import_product'),
                'update_price' => $this->input->post('update_price'), 
                'products-quantity_adjustments' => $this->input->post('quantity_adjustments'), 
                'products-quantity_excel' => $this->input->post('products-quantity_excel'), 
                'products-quantity_pdf' => $this->input->post('products-quantity_pdf'), 
                'products-quantity_delete' => $this->input->post('products-quantity_delete'), 
                'products-print_barcodes' => $this->input->post('products_print_barcodes'),
                'products-print_labels' => $this->input->post('products_print_labels'),
                'products-sync_quantity' => $this->input->post('products-sync_quantity'),
                'products-export_excel' => $this->input->post('export_excel'),
                'products-export_pdf' => $this->input->post('export_pdf'),
                'products-details' => $this->input->post('products_details'),
                'products-duplicate' => $this->input->post('products_duplicate'),
                'products-image' => $this->input->post('products_image'),
                'products-adjust_quantity' => $this->input->post('adjust_quantity'),
                'sales-list' => $this->input->post('sales-list'),                  
                'add_sale_by_csv' => $this->input->post('add_sale_by_csv'),                 
                'credit_voucher' => $this->input->post('credit_voucher'),
                'purchases-list' => $this->input->post('purchases-list'),                
                'purchase-add_by_csv' => $this->input->post('purchase-add_by_csv'),                
                'purchase-expense_add' => $this->input->post('purchase-expense_add'),
                'transfers-list' => $this->input->post('transfers-list'),                
                'transfers-add_by_csv' => $this->input->post('transfers-add_by_csv'),
                'transfers-details' => $this->input->post('transfers-details'),
                'users_list' => $this->input->post('users_list'),
                'users-add' => $this->input->post('users-add'),
                'billers-list' => $this->input->post('billers-list'),
                'billers-add' => $this->input->post('billers-add'),
                'billers-excel' => $this->input->post('billers-excel'),
                'billers-pdf' => $this->input->post('billers-pdf'),
                'billers-delete' => $this->input->post('billers-delete'),
                'sales-excel' => $this->input->post('sales-sales_excel'),               
                'sales-view_payments' => $this->input->post('sales-view_payments'),
                'sales-sales_details' => $this->input->post('sales-sales_details'),
                'sales-pdf_delivery' => $this->input->post('sales-pdf_delivery'),
                'sales-excel_delivery' => $this->input->post('sales-excel_delivery'), 
                'sales-details_delivery' => $this->input->post('sales-details_delivery'), 
                'sales-gift_pdf' => $this->input->post('sales-gift_pdf'), 
                'sales-gift_excel' => $this->input->post('sales-gift_excel'),
                'sales-credit_voucher_setting' => $this->input->post('sales-credit_voucher_setting'), 
                'sales-credit_voucher_pdf' => $this->input->post('sales-credit_voucher_pdf'), 
                'sales-credit_voucher_excel' => $this->input->post('sales-credit_voucher_excel'), 
                'sales-credit_voucher_add' => $this->input->post('sales-credit_voucher_add'), 
                'sales-credit_voucher_edit' => $this->input->post('sales-credit_voucher_edit'),
                'sales-credit_voucher_delete' => $this->input->post('sales-credit_voucher_delete'), 
                'pos-sale_add' => $this->input->post('pos-sale_add')?$this->input->post('pos-sale_add'):NULL,
                'pos-sales_delete' => $this->input->post('pos-sales_delete'),
                'pos-sales_email' => $this->input->post('pos-sales_email'),
                'pos-sales_pdf' => $this->input->post('pos-sales_pdf'),
                'pos-sales_excel' => $this->input->post('pos-sales_excel'),
                'pos-sales_payments' => $this->input->post('pos-sales_payments'),
                'pos-view_payments' => $this->input->post('pos-view_payments'),
                'pos-view_reciept' => $this->input->post('pos-view_reciept'),
                'quotes-excel' => $this->input->post('quotes-excel'),
                'quotes-details' => $this->input->post('quotes-details'),
                'quotes-list' => $this->input->post('quotes-list'),
                'purchases-excel' => $this->input->post('purchases-excel'),
                'purchases-details' => $this->input->post('purchases-details'),
                'purchases-view_payments' => $this->input->post('purchases-view_payments'),
                'transfers-excel' => $this->input->post('transfers-excel'),
                'customers-pdf' => $this->input->post('customers-pdf'),
                'customers-excel' => $this->input->post('customers-excel'),
                'customers-add_by_csv' => $this->input->post('customers-add_by_csv'),
                'users-delete_users' => $this->input->post('users-delete_users'),
                'users-pdf' => $this->input->post('users-pdf'),
                'users-excel' => $this->input->post('users-excel'),
                'suppliers-pdf' => $this->input->post('suppliers-pdf'),
                'suppliers-excel' => $this->input->post('suppliers-excel'),
                'suppliers-add_by_csv' => $this->input->post('suppliers-add_by_csv'),
                ...
                'backups' => $this->input->post('backups'),
                'update_version' => $this->input->post('update_version'),
                'reports-index' => $this->input->post('reports-index'),
                'overview_chart' => $this->input->post('overview_chart'),
                'reports-warehouse_stock' => $this->input->post('reports-warehouse_stock'),
                'register_report' => $this->input->post('register_report'),
                'categories_report' => $this->input->post('categories_report'),
                ...
                'pos-pos_tip' => $this->input->post('pos-pos_tip'), 
                'pos-tip_calc' => $this->input->post('pos-tip_calc'),  
                'pos-tip_holdsale' => $this->input->post('pos-tip_holdsale'),  
                'pos-tip_registerdetails' => $this->input->post('pos-tip_registerdetails'),  
                'pos-tip_closeregister' => $this->input->post('pos-tip_closeregister'),  
                'pos-tip_addexpense' => $this->input->post('pos-tip_addexpense'),  
                'pos-tip_todayprofit' => $this->input->post('pos-tip_todayprofit'),  
                'pos-tip_todaysale' => $this->input->post('pos-tip_todaysale'),  
                'pos-tip_openregister' => $this->input->post('pos-tip_openregister'),  
                'pos-tip_cleardata' => $this->input->post('pos-tip_cleardata'), 
                'pos-tip_accessories' => $this->input->post('pos-tip_accessories'),    
        ...
        if ($this->form_validation->run() == true && $this->settings_model->updatePermissions($id, $data)) {
            ...
            if ($this->input->post('reports-expiry_alerts')) {
                $this->settings_model->updateProductExpirySetting($this->input->post('reports-expiry_alerts'));
            }
    ...
    function groupPermissionsPdf($id = NULL){
        $this->data['id'] = $id;
        $this->data['p'] = $this->settings_model->getGroupPermissions($id);
        $this->data['group'] = $this->settings_model->getGroupByID($id);
        
        $name = $this->data['group']->name."_permissions.pdf";
        $bc = array(array('link' => base_url(), 'page' => lang('home')), array('link' => site_url('system_settings'), 'page' => lang('system_settings')), array('link' => '#', 'page' => lang('group_permissions')));
        $meta = array('page_title' => lang('group_permissions'), 'bc' => $bc);
        $html = $this->load->view($this->theme . 'settings/permissions_pdf', $this->data, TRUE);
//        $html = utf8_decode($html);
    ...
    function user_groups() {
        ...
        //***** Added By Anil 20-09-2016 start****        
            $arr_ugroups = $this->site->checkPermissions(); 
            if($arr_ugroups[0]['group_permissions'] == NULL && ! $this->Owner){
                $this->session->set_flashdata('error', lang("access_denied"));
                redirect('welcome'); 
            }
        if (!$this->Owner && !$this->Admin && ! $this->Manager) { 
        ...
        $this->data['error'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('error');
        // *** Added by Anil 20-09-2016 ***
        if($this->Owner){ 
            $this->data['groups'] = $this->settings_model->getGroups();
        } elseif($this->Admin) {
            $this->data['groups'] = $this->settings_model->getGroupsAdmin();            
        } else{           
           $this->data['groups'] = $this->settings_model->getGroupsManager();
        } 
        // ***end*** 
    ...
    function currencies() {
        //***** Added By Anil 20-09-2016 start****        
            $arr_currencies = $this->site->checkPermissions(); 
            if($arr_currencies[0]['currencies'] == NULL && ! $this->Owner){
                $this->session->set_flashdata('error', lang("access_denied"));
                redirect('welcome'); 
            }
        //***** Added By Anil 20-09-2016 End**** 
    ...
    function currency_actions() {
        ...
        if ($this->form_validation->run() == true) {
            ...
            if (!empty($_POST['val'])) {
                ...
                $this->session->set_flashdata('error', lang("No_Currency_Row_selected"));
                redirect($_SERVER["HTTP_REFERER"]);
            }
        } else {
            $this->session->set_flashdata('error', validation_errors());
    ...
    function add_category() {
        ...
        $this->form_validation->set_rules('tax_rate', lang("category_tax_rate"), 'required|greater_than[0]');
        if ($this->form_validation->run() == true) {
            $name = $this->input->post('name');
        ...
        if ($this->form_validation->run() == true && $this->settings_model->addCategory($name, $code, $photo, $tax_rate)) {
    ...
    function edit_category($id = NULL) {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array('code' => $this->input->post('code'),
                'name' => $this->input->post('name'),
                'tax_rate_id' => $this->input->post('tax_rate')
            );
            if ($_FILES['userfile']['size'] > 0) {
                $this->load->library('upload');
                $config['upload_path'] = $this->upload_path;
        ...
        if ($this->form_validation->run() == true && $this->settings_model->updateCategory($id, $data, $photo)) {
            ...
            $this->data['tax_rates'] = $this->settings_model->getAllTaxRates();
            $this->data['t_rate'] = $category->tax_rate_id;
            $this->data['modal_js'] = $this->site->modal_js();
            $this->data['id'] = $id;
