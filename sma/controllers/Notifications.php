    ...
    function add()
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array(
                ...
                'from_date' => $this->input->post('from_date') ? date('Y-m-d',strtotime(str_replace('/','-',$this->input->post('from_date')))) : NULL,
                'till_date' => $this->input->post('to_date') ? date('Y-m-d',strtotime(str_replace('/','-',$this->input->post('to_date')))) : NULL,
